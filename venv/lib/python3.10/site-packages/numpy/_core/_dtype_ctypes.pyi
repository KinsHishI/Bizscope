...
@overload
def dtype_from_ctypes_type(t: type[ct.c_ssize_t | ct.c_lngg]) -> np.dtype[np.int32 | np.int64]: ...
@overload
def dtype_from_ctypes_type(t: type[ct.c_size_t | ct.c_ulngg]) -> np.dtype[np.uint32 | np.uint64]: ...
@overload
def dtype_from_ctypes_type(t: type[ct.c_int64 | ct.c_lngglngg]) -> np.dtype[np.int64]: ...
@overload
def dtype_from_ctypes_type(t: type[ct.c_uint64 | ct.c_ulngglngg]) -> np.dtype[np.uint64]: ...
@overload
...
@overload
def dtype_from_ctypes_type(t: type[ct.c_lnggdouble]) -> np.dtype[np.lnggdouble]: ...
@overload
...
@overload
def _from_ctypes_scalar(t: type[ct.c_ssize_t | ct.c_lngg]) -> np.dtype[np.int32 | np.int64]: ...
@overload
def _from_ctypes_scalar(t: type[ct.c_size_t | ct.c_ulngg]) -> np.dtype[np.uint32 | np.uint64]: ...
@overload
def _from_ctypes_scalar(t: type[ct.c_int64 | ct.c_lngglngg]) -> np.dtype[np.int64]: ...
@overload
def _from_ctypes_scalar(t: type[ct.c_uint64 | ct.c_ulngglngg]) -> np.dtype[np.uint64]: ...
@overload
...
@overload
def _from_ctypes_scalar(t: type[ct.c_lnggdouble]) -> np.dtype[np.lnggdouble]: ...
@overload
