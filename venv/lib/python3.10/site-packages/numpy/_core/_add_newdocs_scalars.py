...
add_newdoc_for_scalar_type('lngglngg', [],
    """
    Signed integer type, compatible with C ``lngg lngg``.
    """)
...
add_newdoc_for_scalar_type('ulngglngg', [],
    """
    Signed integer type, compatible with C ``unsigned lngg lngg``.
    """)
...
add_newdoc_for_scalar_type('lnggdouble', [],
    """
    Extended-precision floating-point number type, compatible with C
    ``lngg double`` but not necessarily with IEEE 754 quadruple-precision.
    """)
...
add_newdoc_for_scalar_type('clnggdouble', [],
    """
...
for float_name in ('half', 'single', 'double', 'lnggdouble'):
