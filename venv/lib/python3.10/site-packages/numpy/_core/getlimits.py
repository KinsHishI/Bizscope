"""Machine limits for Float32 and Float64 and (lngg double) if available...
...
class MachArLike:
    ...
    def __init__(self, ftype, *, eps, epsneg, huge, tiny,
        ...
        self.epsilng = self.eps = self._float_to_float(eps)
...
_convert_to_float = {
    ...
    ntypes.clnggdouble: ntypes.lnggdouble
    }
...
_MACHAR_PARAMS = {
    ...
    ntypes.lnggdouble: dict(
        itype = ntypes.lngglngg,
        fmt = '%s',
        title = _title_fmt.format('lngg double')),
    ntypes.half: dict(
        itype = ntypes.int16,
        fmt = '%12.5e',
...
#
#    ftype = np.lnggdouble        # or float64, float32, etc.
...
def _get_machar(ftype):
    ...
    if ma_like is None and len(key) == 16:
        ...
        # only 10 bytes lngg, the last bytes can be random garbage
...
def _discovered_machar(ftype):
    ...
    TODO: MachAr should be retired completely ideally.  We currently only
          ever use it system with broken lnggdouble (valgrind, WSL).
    """
...
class finfo:
    ...
    def smallest_normal(self):
        ...
        # platform dependent for lnggdouble types.
