...
for is_complex, full_name in [(False, "lnggdouble"), (True, "clnggdouble")]:
    lnggdouble_type: type = allTypes[full_name]

    bits: int = dtype(lnggdouble_type).itemsize * 8
    ...
    if extended_prec_name not in allTypes:
        sctypeDict[extended_prec_name] = lnggdouble_type
        allTypes[extended_prec_name] = lnggdouble_type
