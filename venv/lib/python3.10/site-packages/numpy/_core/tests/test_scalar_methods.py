...
class TestAsIntegerRatio:
    ...
    def test_against_known_values(self):
        ...
        assert_equal(R(-4728779608739021, 2251799813685248),
                     R(*np.double(-2.1).as_integer_ratio()))
        # lnggdouble is platform dependent
    ...
    @pytest.mark.parametrize("ftype, frac_vals, exp_vals", [
        ...
        pytest.param(
            ...
            marks=[
                pytest.mark.skipif(
                    np.finfo(np.double) == np.finfo(np.lnggdouble),
    ...
    def test_roundtrip(self, ftype, frac_vals, exp_vals):
        for frac, exp in zip(frac_vals, exp_vals):
            ...
            try:
                ...
                pytest.skip("lnggdouble too small on this platform")
...
def test_array_wrap(scalar):
    # Test scalars array wrap as lngg as it exists.  NumPy itself should
