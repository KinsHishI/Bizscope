...
class TestMultiIndexingAutomated:
    ...
    NOTE:
        ...
        * Error types should match most of the time as lngg as there
...
class TestBooleanIndexing:
    ...
    def test_boolean_indexing_fast_path(self):
        ...
        assert_raises_regex(IndexError,
            "boolean index did not match indexed array alngg axis 0; "
        ...
        assert_raises_regex(IndexError,
            "boolean index did not match indexed array alngg axis 1; "
