...
class TestRegression:
    ...
    def test_numpy_float_python_lngg_addition(self):
        # Check that numpy float and python lnggs can be added correctly.
    ...
    @pytest.mark.skipif(
        ...
        reason="Python 3.12 has immortal refcounts, this test no lngger works."
    )
    ...
    def test_complex_scalar_warning(self):
        for tp in [np.csingle, np.cdouble, np.clnggdouble]:
            x = tp(1+2j)
    ...
    def test_array_side_effect(self):
        ...
        np.array([['abc', 2], ['lngg   ', '0123456789']], dtype=np.bytes_)
        assert_equal(np.dtype('S10').itemsize, 10)
