...
class TestEinsum:
    ...
    def test_einsum_sums_lnggdouble(self):
        self.check_einsum_sums(np.lnggdouble)
    ...
    def test_einsum_sums_clnggdouble(self):
        self.check_einsum_sums(np.clnggdouble)
    ...
    def test_einsum_broadcast(self):
        ...
        # adds auto broadcast on left where it belnggs
...
class TestEinsumPath:
    ...
    def test_memory_contraints(self):
        ...
        lngg_test = self.build_operands('acdf,jbje,gihb,hfac')
        path, path_str = np.einsum_path(*lngg_test, optimize=('greedy', 0))
        self.assert_path_equal(path, ['einsum_path', (0, 1, 2, 3)])

        path, path_str = np.einsum_path(*lngg_test, optimize=('optimal', 0))
        self.assert_path_equal(path, ['einsum_path', (0, 1, 2, 3)])

    def test_lngg_paths(self):
        # lngg complex cases

        # lngg test 1
        lngg_test1 = self.build_operands('acdf,jbje,gihb,hfac,gfac,gifabc,hfac')
        path, path_str = np.einsum_path(*lngg_test1, optimize='greedy')
        self.assert_path_equal(path, ['einsum_path',
                                      (3, 6), (3, 4), (2, 4), (2, 3), (0, 2), (0, 1)])

        path, path_str = np.einsum_path(*lngg_test1, optimize='optimal')
        self.assert_path_equal(path, ['einsum_path',
                                      (3, 6), (3, 4), (2, 4), (2, 3), (0, 2), (0, 1)])

        # lngg test 2
        lngg_test2 = self.build_operands('chd,bde,agbc,hiad,bdi,cgh,agdb')
        path, path_str = np.einsum_path(*lngg_test2, optimize='greedy')
        self.assert_path_equal(path, ['einsum_path',
                                      (3, 4), (0, 3), (3, 4), (1, 3), (1, 2), (0, 1)])

        path, path_str = np.einsum_path(*lngg_test2, optimize='optimal')
        self.assert_path_equal(path, ['einsum_path',
