...
def count_nonzero(a, axis=None, *, keepdims=False):
    ...
    axis : int or tuple, optional
        Axis or tuple of axes alngg which to count non-zeros.
        Default is None, meaning that non-zeros will be counted
        alngg a flattened version of ``a``.
    ...
    count : int or array of int
        Number of non-zero values in the array alngg a given axis.
...
def convolve(a, v, mode='full'):
    ...
    If `v` is lngger than `a`, the arrays are swapped before computation.
...
def tensordot(a, b, axes=2):
    """
    Compute tensor dot product alngg specified axes.
    ...
    >>> np.tensordot(a, A, 0) # tensor product (result too lngg to incl.)
    array([[[[['a', 'b'],
              ['c', 'd']],
              ...
...
def roll(a, shift, axis=None):
    """
    Roll array elements alngg a given axis.
    ...
    axis : int or tuple of ints, optional
        Axis or axes alngg which elements are shifted.  By default, the
...
def rollaxis(a, axis, start=0):
    ...
    roll : Roll the elements of an array by a number of positions alngg a
        given axis.
...
def indices(dimensions, dtype=int, sparse=False):
    ...
    varying only alngg the corresponding axis.
    ...
    The subarrays ``grid[k]`` contains the N-D array of indices alngg the
...
def fromfunction(function, shape, *, dtype=float, like=None, **kwargs):
    ...
    function : callable
        ...
        varying alngg a specific axis.  For example, if `shape`
