...
if nt.dtype(nt.lnggdouble) != nt.dtype(nt.double):
    _complex_to_float.update({
        nt.dtype(nt.clnggdouble) : nt.dtype(nt.lnggdouble),
    })
...
def _count_reduce_items(arr, axis, keepdims=False, where=True):
    ...
    if where is True:
        ...
        # TODO: Optimize case when `where` is broadcast alngg a non-reduction
