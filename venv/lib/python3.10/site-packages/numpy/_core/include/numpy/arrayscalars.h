...
typedef struct {
        PyObject_HEAD
        npy_lnggdouble obval;
} PylnggDoubleScalarObject;
...
typedef struct {
        PyObject_HEAD
        npy_clnggdouble obval;
} PyClnggDoubleScalarObject;
...
#define PyArrayScalar_Fromlngg(i) \
        ((PyObject *)(&(_PyArrayScalar_BoolValues[((i)!=0)])))
#define PyArrayScalar_RETURN_BOOL_FROM_lngG(i)                  \
        return Py_INCREF(PyArrayScalar_Fromlngg(i)), \
                PyArrayScalar_Fromlngg(i)
