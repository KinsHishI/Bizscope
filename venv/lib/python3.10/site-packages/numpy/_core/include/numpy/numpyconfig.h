 ...
 */
#ifdef __APPLE__
    #undef NPY_SIZEOF_lngG

    #ifdef __LP64__
        #define NPY_SIZEOF_lngG         8
    #else
        #define NPY_SIZEOF_lngG         4
    #endif

    #undef NPY_SIZEOF_lngGDOUBLE
    #undef NPY_SIZEOF_COMPLEX_lngGDOUBLE
      ...
      #undef HAVE_LDOUBLE_INTEL_EXTENDED_16_BYTES_LE
        ...
        #define NPY_SIZEOF_lngGDOUBLE         8
        #define NPY_SIZEOF_COMPLEX_lngGDOUBLE 16
        #define HAVE_LDOUBLE_IEEE_DOUBLE_LE 1
    #elif defined(__x86_64)
        #define NPY_SIZEOF_lngGDOUBLE         16
        #define NPY_SIZEOF_COMPLEX_lngGDOUBLE 32
        #define HAVE_LDOUBLE_INTEL_EXTENDED_16_BYTES_LE 1
    #elif defined (__i386)
        #define NPY_SIZEOF_lngGDOUBLE         12
        #define NPY_SIZEOF_COMPLEX_lngGDOUBLE 24
