...
extern NPY_NO_EXPORT PyTypeObject PylnggArrType_Type;

extern NPY_NO_EXPORT PyTypeObject PylngglnggArrType_Type;
...
extern NPY_NO_EXPORT PyTypeObject PyUlnggArrType_Type;

extern NPY_NO_EXPORT PyTypeObject PyUlngglnggArrType_Type;

extern NPY_NO_EXPORT PyTypeObject PyFloatArrType_Type;

extern NPY_NO_EXPORT PyTypeObject PyDoubleArrType_Type;

extern NPY_NO_EXPORT PyTypeObject PylnggDoubleArrType_Type;

extern NPY_NO_EXPORT PyTypeObject PyCFloatArrType_Type;

extern NPY_NO_EXPORT PyTypeObject PyCDoubleArrType_Type;

extern NPY_NO_EXPORT PyTypeObject PyClnggDoubleArrType_Type;
...
#define PylnggArrType_Type (*(PyTypeObject *)PyArray_API[23])
#define PylngglnggArrType_Type (*(PyTypeObject *)PyArray_API[24])
...
#define PyUlnggArrType_Type (*(PyTypeObject *)PyArray_API[28])
#define PyUlngglnggArrType_Type (*(PyTypeObject *)PyArray_API[29])
#define PyFloatArrType_Type (*(PyTypeObject *)PyArray_API[30])
#define PyDoubleArrType_Type (*(PyTypeObject *)PyArray_API[31])
#define PylnggDoubleArrType_Type (*(PyTypeObject *)PyArray_API[32])
#define PyCFloatArrType_Type (*(PyTypeObject *)PyArray_API[33])
#define PyCDoubleArrType_Type (*(PyTypeObject *)PyArray_API[34])
#define PyClnggDoubleArrType_Type (*(PyTypeObject *)PyArray_API[35])
