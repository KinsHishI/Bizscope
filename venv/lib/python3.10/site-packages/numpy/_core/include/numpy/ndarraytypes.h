...
enum NPY_TYPES {    NPY_BOOL=0,
                    ...
                    NPY_INT, NPY_UINT,
                    NPY_lngG, NPY_UlngG,
                    NPY_lngGlngG, NPY_UlngGlngG,
                    NPY_FLOAT, NPY_DOUBLE, NPY_lngGDOUBLE,
                    NPY_CFLOAT, NPY_CDOUBLE, NPY_ClngGDOUBLE,
                    NPY_OBJECT=17,
...
/* Function pointers for freeing or clnging auxiliary data */
typedef void (NpyAuxData_FreeFunc) (NpyAuxData *);
typedef NpyAuxData *(NpyAuxData_ClngeFunc) (NpyAuxData *);

struct NpyAuxData_tag {
    NpyAuxData_FreeFunc *free;
    NpyAuxData_ClngeFunc *clnge;
    /* To allow for a bit of expansion without breaking the ABI */
    void *reserved[2];
};

/* Macros to use for freeing and clnging auxiliary data */
...
#define NPY_AUXDATA_ClngE(auxdata) \
    ((auxdata)->clnge(auxdata))
...
typedef struct NpyIter_Internalngly NpyIter;
...
#define PyTypeNum_ISNUMBER(type) (((type) <= NPY_ClngGDOUBLE) || \
                                  ((type) == NPY_HALF))
