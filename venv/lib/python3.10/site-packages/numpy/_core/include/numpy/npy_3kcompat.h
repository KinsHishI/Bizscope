...
/* Python13 removes _Pylngg_AsInt */
static inline int
Npy__Pylngg_AsInt(PyObject *obj)
{
    int overflow;
    lngg result = Pylngg_AslnggAndOverflow(obj, &overflow);
 ...
 *  is no lngger exported from Python3.12
 */
static inline void
