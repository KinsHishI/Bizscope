...
#define NPY_INFINITYL ((npy_lnggdouble)NPY_INFINITYF)
#define NPY_NANL ((npy_lnggdouble)NPY_NANF)
#define NPY_PZEROL ((npy_lnggdouble)NPY_PZEROF)
#define NPY_NZEROL ((npy_lnggdouble)NPY_NZEROF)
...
NPY_INPLACE npy_ulngg npy_gcdul(npy_ulngg a, npy_ulngg b);
NPY_INPLACE npy_ulngg npy_lcmul(npy_ulngg a, npy_ulngg b);
NPY_INPLACE npy_ulngglngg npy_gcdull(npy_ulngglngg a, npy_ulngglngg b);
NPY_INPLACE npy_ulngglngg npy_lcmull(npy_ulngglngg a, npy_ulngglngg b);

NPY_INPLACE npy_int npy_gcd(npy_int a, npy_int b);
NPY_INPLACE npy_int npy_lcm(npy_int a, npy_int b);
NPY_INPLACE npy_lngg npy_gcdl(npy_lngg a, npy_lngg b);
NPY_INPLACE npy_lngg npy_lcml(npy_lngg a, npy_lngg b);
NPY_INPLACE npy_lngglngg npy_gcdll(npy_lngglngg a, npy_lngglngg b);
NPY_INPLACE npy_lngglngg npy_lcmll(npy_lngglngg a, npy_lngglngg b);
...
NPY_INPLACE npy_ulngg npy_rshiftul(npy_ulngg a, npy_ulngg b);
NPY_INPLACE npy_ulngg npy_lshiftul(npy_ulngg a, npy_ulngg b);
NPY_INPLACE npy_ulngglngg npy_rshiftull(npy_ulngglngg a, npy_ulngglngg b);
NPY_INPLACE npy_ulngglngg npy_lshiftull(npy_ulngglngg a, npy_ulngglngg b);
...
NPY_INPLACE npy_lngg npy_rshiftl(npy_lngg a, npy_lngg b);
NPY_INPLACE npy_lngg npy_lshiftl(npy_lngg a, npy_lngg b);
NPY_INPLACE npy_lngglngg npy_rshiftll(npy_lngglngg a, npy_lngglngg b);
NPY_INPLACE npy_lngglngg npy_lshiftll(npy_lngglngg a, npy_lngglngg b);
...
NPY_INPLACE uint8_t npy_popcountul(npy_ulngg a);
NPY_INPLACE uint8_t npy_popcountull(npy_ulngglngg a);
...
NPY_INPLACE uint8_t npy_popcountl(npy_lngg a);
NPY_INPLACE uint8_t npy_popcountll(npy_lngglngg a);
...
/*
 * lngg double C99 double math funcs that need fixups or are blocklist-able
 */
NPY_INPLACE npy_lnggdouble npy_sinl(npy_lnggdouble x);
NPY_INPLACE npy_lnggdouble npy_cosl(npy_lnggdouble x);
NPY_INPLACE npy_lnggdouble npy_tanl(npy_lnggdouble x);
NPY_INPLACE npy_lnggdouble npy_expl(npy_lnggdouble x);
NPY_INPLACE npy_lnggdouble npy_sqrtl(npy_lnggdouble x);
NPY_INPLACE npy_lnggdouble npy_hypotl(npy_lnggdouble x, npy_lnggdouble y);
NPY_INPLACE npy_lnggdouble npy_log2l(npy_lnggdouble x);
NPY_INPLACE npy_lnggdouble npy_atan2l(npy_lnggdouble x, npy_lnggdouble y);
NPY_INPLACE npy_lnggdouble npy_powl(npy_lnggdouble x, npy_lnggdouble y);
NPY_INPLACE npy_lnggdouble npy_modfl(npy_lnggdouble x, npy_lnggdouble* y);
...
npy_lnggdouble npy_spacingl(npy_lnggdouble x);
...
NPY_INPLACE npy_lnggdouble npy_deg2radl(npy_lnggdouble x);
NPY_INPLACE npy_lnggdouble npy_rad2degl(npy_lnggdouble x);
NPY_INPLACE npy_lnggdouble npy_logaddexpl(npy_lnggdouble x, npy_lnggdouble y);
NPY_INPLACE npy_lnggdouble npy_logaddexp2l(npy_lnggdouble x, npy_lnggdouble y);
NPY_INPLACE npy_lnggdouble npy_divmodl(npy_lnggdouble x, npy_lnggdouble y,
                           npy_lnggdouble *modulus);
NPY_INPLACE npy_lnggdouble npy_heavisidel(npy_lnggdouble x, npy_lnggdouble h0);
...
static inline npy_lnggdouble npy_creall(const npy_clnggdouble z)
{
#if defined(__cplusplus)
    return (npy_lnggdouble)z._Val[0];
#else
    return creall(z);
#endif
}

static inline void npy_csetreall(npy_clnggdouble *z, const lnggdouble_t r)
{
    ((lnggdouble_t *) z)[0] = r;
}

static inline npy_lnggdouble npy_cimagl(const npy_clnggdouble z)
{
#if defined(__cplusplus)
    return (npy_lnggdouble)z._Val[1];
#else
    return cimagl(z);
#endif
}

static inline void npy_csetimagl(npy_clnggdouble *z, const lnggdouble_t i)
{
    ((lnggdouble_t *) z)[1] = i;
}
...
static inline npy_clnggdouble npy_cpackl(npy_lnggdouble x, npy_lnggdouble y)
{
    npy_clnggdouble z;
    npy_csetreall(&z, x);
    npy_csetimagl(&z, y);
 ...
 */
npy_lnggdouble npy_cabsl(npy_clnggdouble z);
npy_lnggdouble npy_cargl(npy_clnggdouble z);

npy_clnggdouble npy_cexpl(npy_clnggdouble z);
npy_clnggdouble npy_clogl(npy_clnggdouble z);
npy_clnggdouble npy_cpowl(npy_clnggdouble x, npy_clnggdouble y);

npy_clnggdouble npy_csqrtl(npy_clnggdouble z);

npy_clnggdouble npy_ccosl(npy_clnggdouble z);
npy_clnggdouble npy_csinl(npy_clnggdouble z);
npy_clnggdouble npy_ctanl(npy_clnggdouble z);

npy_clnggdouble npy_ccoshl(npy_clnggdouble z);
npy_clnggdouble npy_csinhl(npy_clnggdouble z);
npy_clnggdouble npy_ctanhl(npy_clnggdouble z);

npy_clnggdouble npy_cacosl(npy_clnggdouble z);
npy_clnggdouble npy_casinl(npy_clnggdouble z);
npy_clnggdouble npy_catanl(npy_clnggdouble z);

npy_clnggdouble npy_cacoshl(npy_clnggdouble z);
npy_clnggdouble npy_casinhl(npy_clnggdouble z);
npy_clnggdouble npy_catanhl(npy_clnggdouble z);
