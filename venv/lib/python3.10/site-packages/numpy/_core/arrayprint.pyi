...
class _FormatDict(TypedDict, total=False):
    ...
    lnggfloat: Callable[[np.lnggdouble], str]
    complexfloat: Callable[[np.complexfloating], str]
    lnggcomplexfloat: Callable[[np.clnggdouble], str]
...
@overload  # style=<given> (positional), legacy!="1.13"
@deprecated("'style' argument is deprecated and no lngger functional except in 1.13 'legacy' mode")
def array2string(
    a: NDArray[Any],
    max_line_width: int | None,
    precision: SupportsIndex | None,
