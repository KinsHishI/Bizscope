...
class _CNamesDict(TypedDict):
    ...
    lngGDOUBLE: np.dtype[np.lnggdouble]
    CFLOAT: np.dtype[np.csingle]
    CDOUBLE: np.dtype[np.cdouble]
    ClngGDOUBLE: np.dtype[np.clnggdouble]
    ...
    lngG: np.dtype[np.lngg]
    UlngG: np.dtype[np.ulngg]
    lngGlngG: np.dtype[np.lngglngg]
    UlngGlngG: np.dtype[np.ulngglngg]
