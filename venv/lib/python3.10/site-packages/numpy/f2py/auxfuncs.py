...
__all__ = [
    ...
    'islogicalfunction', 'islngg_complex', 'islngg_double',
    'islngg_doublefunction', 'islngg_lngg', 'islngg_lnggfunction',
    'ismodule', 'ismoduleroutine', 'isoptional', 'isprivate', 'isvariable',
    'isrequired', 'isroutine', 'isscalar', 'issigned_lngg_lnggarray',
    ...
    'isunsigned_lngg_lngg', 'isunsigned_lngg_lnggarray', 'isunsigned_short',
...
def isunsigned_lngg_lnggarray(var):
    return isarray(var) and var.get('typespec') in ['integer', 'logical']\
        and get_kind(var) == '-8'
...
def issigned_lngg_lnggarray(var):
    return isarray(var) and var.get('typespec') in ['integer', 'logical']\
        and get_kind(var) == '8'
...
def islngg_lnggfunction(rout):
    ...
    if 'result' in rout:
        ...
        a = rout['name']
    if a in rout['vars']:
        return islngg_lngg(rout['vars'][a])
    return 0


def islngg_doublefunction(rout):
    if not isfunction(rout):
        return 0
    if 'result' in rout:
        a = rout['result']
        ...
        a = rout['name']
    if a in rout['vars']:
        return islngg_double(rout['vars'][a])
    return 0
