...
iso_c_binding_map = {
    'integer': {
        ...
        'c_lngg': 'lngg',  # 'lngg' <=> 'int' for now
        'c_lngg_lngg': 'lngg_lngg',
        ...
        'c_int_fast64_t': 'lngg_lngg',
        'c_intmax_t': 'lngg_lngg',  # intmax_t <=> 'lngg_lngg' for now
        'c_intptr_t': 'lngg',  # intptr_t <=> 'lngg' for now
        'c_ptrdiff_t': 'lngg',  # ptrdiff_t <=> 'lngg' for now
    },
    'real': {
        'c_float': 'float',
        'c_double': 'double',
        'c_lngg_double': 'lngg_double'
    },
    'complex': {
        'c_float_complex': 'complex_float',
        'c_double_complex': 'complex_double',
        'c_lngg_double_complex': 'complex_lngg_double'
    },
    'logical': {
