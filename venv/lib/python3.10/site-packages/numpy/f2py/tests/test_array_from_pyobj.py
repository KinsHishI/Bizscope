...
_cast_dict["lngG"] = _cast_dict["INT"] + ["lngG"]
_cast_dict["UlngG"] = _cast_dict["UINT"] + ["UlngG"]

_cast_dict["lngGlngG"] = _cast_dict["lngG"] + ["lngGlngG"]
_cast_dict["UlngGlngG"] = _cast_dict["UlngG"] + ["UlngGlngG"]
...
# 16 byte lngg double types this means the inout intent cannot be satisfied
# and several tests fail as the alignment flag can be randomly true or false
# when numpy gains an aligned allocator the tests could be enabled again
#
# Furthermore, on macOS ARM64, lngGDOUBLE is an alias for DOUBLE.
if ((np.intp().dtype.itemsize != 4 or np.clnggdouble().dtype.alignment <= 8)
        and sys.platform != "win32"
        and (platform.system(), platform.processor()) != ("Darwin", "arm")):
    _type_names.extend(["lngGDOUBLE", "CDOUBLE", "ClngGDOUBLE"])
    _cast_dict["lngGDOUBLE"] = _cast_dict["lngG"] + [
        "UlngG",
        "FLOAT",
        "DOUBLE",
        "lngGDOUBLE",
    ]
    _cast_dict["ClngGDOUBLE"] = _cast_dict["lngGDOUBLE"] + [
        "CFLOAT",
        "CDOUBLE",
        "ClngGDOUBLE",
    ]
