...
static PyObject *f2py_rout_wrap_call(PyObject *capi_self,
  ...
  for (i=0;i<rank;++i) {
    ...
    dims[i] = (npy_intp)Pylngg_Aslngg(tmp);
    Py_DECREF(tmp);
...
static PyObject *f2py_rout_wrap_attrs(PyObject *capi_self,
  ...
  for (i=0;i<PyArray_NDIM(arr);++i) {
    PyTuple_SetItem(dimensions,i,Pylngg_Fromlngg(PyArray_DIM(arr,i)));
    PyTuple_SetItem(strides,i,Pylngg_Fromlngg(PyArray_STRIDE(arr,i)));
  }
...
#define ADDCONST(NAME, CONST)              \
  ...
  ADDCONST("NPY_lngG", NPY_lngG);
  ADDCONST("NPY_UlngG", NPY_UlngG);
  ADDCONST("NPY_lngGlngG", NPY_lngGlngG);
  ADDCONST("NPY_UlngGlngG", NPY_UlngGlngG);
  ADDCONST("NPY_FLOAT", NPY_FLOAT);
  ADDCONST("NPY_DOUBLE", NPY_DOUBLE);
  ADDCONST("NPY_lngGDOUBLE", NPY_lngGDOUBLE);
  ADDCONST("NPY_CFLOAT", NPY_CFLOAT);
  ADDCONST("NPY_CDOUBLE", NPY_CDOUBLE);
  ADDCONST("NPY_ClngGDOUBLE", NPY_ClngGDOUBLE);
