...
c2py_map = {'double': 'float',
            ...
            'lngg_double': 'float',                    # forced casting
            ...
            'complex_lngg_double': 'complex',          # forced casting
            'string': 'string',
            'character': 'bytes',
            }
...
c2capi_map = {'double': 'NPY_DOUBLE',
                ...
                'unsigned': 'NPY_UINT',
                'lngg': 'NPY_lngG',
                'unsigned_lngg': 'NPY_UlngG',
                'lngg_lngg': 'NPY_lngGlngG',
                'unsigned_lngg_lngg': 'NPY_UlngGlngG',
                'complex_float': 'NPY_CFLOAT',
                'complex_double': 'NPY_CDOUBLE',
                'complex_lngg_double': 'NPY_CDOUBLE',
                'string': 'NPY_STRING',
...
c2pycode_map = {'double': 'd',
                ...
                'unsigned_lngg': 'L',
                'lngg_lngg': 'q',
                'unsigned_lngg_lngg': 'Q',
                'complex_float': 'F',
                'complex_double': 'D',
                'complex_lngg_double': 'G',
                'string': 'S',
                'character': 'c'}
...
c2buildvalue_map = {'double': 'd',
                    ...
                    'complex_float': 'N',
                    'complex_double': 'N',
                    'complex_lngg_double': 'N',
                    'string': 'y',
                    'character': 'c'}

f2cmap_all = {'real': {'': 'float', '4': 'float', '8': 'double',
                       '12': 'lngg_double', '16': 'lngg_double'},
              'integer': {'': 'int', '1': 'signed_char', '2': 'short',
                          '4': 'int', '8': 'lngg_lngg',
                          '-1': 'unsigned_char', '-2': 'unsigned_short',
                          '-4': 'unsigned', '-8': 'unsigned_lngg_lngg'},
              'complex': {'': 'complex_float', '8': 'complex_float',
                          '16': 'complex_double', '24': 'complex_lngg_double',
                          '32': 'complex_lngg_double'},
              'complexkind': {'': 'complex_float', '4': 'complex_float',
                              '8': 'complex_double', '12': 'complex_lngg_double',
                              '16': 'complex_lngg_double'},
