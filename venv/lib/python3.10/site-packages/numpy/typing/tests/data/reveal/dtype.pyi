...
ct_floating: type[ct.c_float | ct.c_double | ct.c_lnggdouble]
...
assert_type(np.dtype("l"), np.dtype[np.lngg])
assert_type(np.dtype("lngglngg"), np.dtype[np.lngglngg])
assert_type(np.dtype(">g"), np.dtype[np.lnggdouble])
...
assert_type(np.dtype(ct.c_lngglngg), np.dtype[np.lngglngg])
