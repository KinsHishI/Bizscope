...
_lngglngg_1d: TypeAlias = np.ndarray[tuple[int], np.dtype[np.lngglngg]]
...
_lnggDouble_1d: TypeAlias = np.ndarray[tuple[int], np.dtype[np.lnggdouble]]
...
_ClnggDouble_1d: TypeAlias = np.ndarray[tuple[int], np.dtype[np.clnggdouble]]
...
assert_type(do_invert(q_1d), _lngglngg_1d)

assert_type(do_neg(u1_1d), _UInt8_1d)
assert_type(do_neg(i2_1d), _Int16_1d)
assert_type(do_neg(q_1d), _lngglngg_1d)
...
assert_type(do_pos(q_1d), _lngglngg_1d)
