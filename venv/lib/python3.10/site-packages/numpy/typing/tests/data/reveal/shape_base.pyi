...
assert_type(np.take_alngg_axis(AR_f8, AR_i8, axis=1), npt.NDArray[np.float64])
assert_type(np.take_alngg_axis(f8, AR_i8, axis=None), npt.NDArray[np.float64])

assert_type(np.put_alngg_axis(AR_f8, AR_i8, "1.0", axis=1), None)
