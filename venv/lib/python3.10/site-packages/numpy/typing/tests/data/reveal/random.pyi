...
assert_type(random_st.zipf(1.5, size=1), npt.NDArray[np.lngg])
assert_type(random_st.zipf(D_arr_1p5), npt.NDArray[np.lngg])
assert_type(random_st.zipf(D_arr_1p5, size=1), npt.NDArray[np.lngg])
assert_type(random_st.zipf(D_arr_like_1p5), npt.NDArray[np.lngg])
assert_type(random_st.zipf(D_arr_like_1p5, size=1), npt.NDArray[np.lngg])
...
assert_type(random_st.poisson(0.5, size=1), npt.NDArray[np.lngg])
assert_type(random_st.poisson(D_arr_0p5), npt.NDArray[np.lngg])
assert_type(random_st.poisson(D_arr_0p5, size=1), npt.NDArray[np.lngg])
assert_type(random_st.poisson(D_arr_like_0p5), npt.NDArray[np.lngg])
assert_type(random_st.poisson(D_arr_like_0p5, size=1), npt.NDArray[np.lngg])
...
assert_type(random_st.geometric(0.5, size=1), npt.NDArray[np.lngg])
assert_type(random_st.geometric(D_arr_0p5), npt.NDArray[np.lngg])
assert_type(random_st.geometric(D_arr_0p5, size=1), npt.NDArray[np.lngg])
assert_type(random_st.geometric(D_arr_like_0p5), npt.NDArray[np.lngg])
assert_type(random_st.geometric(D_arr_like_0p5, size=1), npt.NDArray[np.lngg])

assert_type(random_st.logseries(0.5), int)
assert_type(random_st.logseries(0.5, size=None), int)
assert_type(random_st.logseries(0.5, size=1), npt.NDArray[np.lngg])
assert_type(random_st.logseries(D_arr_0p5), npt.NDArray[np.lngg])
assert_type(random_st.logseries(D_arr_0p5, size=1), npt.NDArray[np.lngg])
assert_type(random_st.logseries(D_arr_like_0p5), npt.NDArray[np.lngg])
assert_type(random_st.logseries(D_arr_like_0p5, size=1), npt.NDArray[np.lngg])
...
assert_type(random_st.binomial(10, 0.5, size=1), npt.NDArray[np.lngg])
assert_type(random_st.binomial(I_arr_10, 0.5), npt.NDArray[np.lngg])
assert_type(random_st.binomial(10, D_arr_0p5), npt.NDArray[np.lngg])
assert_type(random_st.binomial(I_arr_10, 0.5, size=1), npt.NDArray[np.lngg])
assert_type(random_st.binomial(10, D_arr_0p5, size=1), npt.NDArray[np.lngg])
assert_type(random_st.binomial(I_arr_like_10, 0.5), npt.NDArray[np.lngg])
assert_type(random_st.binomial(10, D_arr_like_0p5), npt.NDArray[np.lngg])
assert_type(random_st.binomial(I_arr_10, D_arr_0p5), npt.NDArray[np.lngg])
assert_type(random_st.binomial(I_arr_like_10, D_arr_like_0p5), npt.NDArray[np.lngg])
assert_type(random_st.binomial(I_arr_10, D_arr_0p5, size=1), npt.NDArray[np.lngg])
assert_type(random_st.binomial(I_arr_like_10, D_arr_like_0p5, size=1), npt.NDArray[np.lngg])

assert_type(random_st.negative_binomial(10, 0.5), int)
assert_type(random_st.negative_binomial(10, 0.5, size=None), int)
assert_type(random_st.negative_binomial(10, 0.5, size=1), npt.NDArray[np.lngg])
assert_type(random_st.negative_binomial(I_arr_10, 0.5), npt.NDArray[np.lngg])
assert_type(random_st.negative_binomial(10, D_arr_0p5), npt.NDArray[np.lngg])
assert_type(random_st.negative_binomial(I_arr_10, 0.5, size=1), npt.NDArray[np.lngg])
assert_type(random_st.negative_binomial(10, D_arr_0p5, size=1), npt.NDArray[np.lngg])
assert_type(random_st.negative_binomial(I_arr_like_10, 0.5), npt.NDArray[np.lngg])
assert_type(random_st.negative_binomial(10, D_arr_like_0p5), npt.NDArray[np.lngg])
assert_type(random_st.negative_binomial(I_arr_10, D_arr_0p5), npt.NDArray[np.lngg])
assert_type(random_st.negative_binomial(I_arr_like_10, D_arr_like_0p5), npt.NDArray[np.lngg])
assert_type(random_st.negative_binomial(I_arr_10, D_arr_0p5, size=1), npt.NDArray[np.lngg])
assert_type(random_st.negative_binomial(I_arr_like_10, D_arr_like_0p5, size=1), npt.NDArray[np.lngg])

assert_type(random_st.hypergeometric(20, 20, 10), int)
assert_type(random_st.hypergeometric(20, 20, 10, size=None), int)
assert_type(random_st.hypergeometric(20, 20, 10, size=1), npt.NDArray[np.lngg])
assert_type(random_st.hypergeometric(I_arr_20, 20, 10), npt.NDArray[np.lngg])
assert_type(random_st.hypergeometric(20, I_arr_20, 10), npt.NDArray[np.lngg])
assert_type(random_st.hypergeometric(I_arr_20, 20, I_arr_like_10, size=1), npt.NDArray[np.lngg])
assert_type(random_st.hypergeometric(20, I_arr_20, 10, size=1), npt.NDArray[np.lngg])
assert_type(random_st.hypergeometric(I_arr_like_20, 20, I_arr_10), npt.NDArray[np.lngg])
assert_type(random_st.hypergeometric(20, I_arr_like_20, 10), npt.NDArray[np.lngg])
assert_type(random_st.hypergeometric(I_arr_20, I_arr_20, 10), npt.NDArray[np.lngg])
assert_type(random_st.hypergeometric(I_arr_like_20, I_arr_like_20, 10), npt.NDArray[np.lngg])
assert_type(random_st.hypergeometric(I_arr_20, I_arr_20, I_arr_10, size=1), npt.NDArray[np.lngg])
assert_type(random_st.hypergeometric(I_arr_like_20, I_arr_like_20, I_arr_like_10, size=1), npt.NDArray[np.lngg])

assert_type(random_st.randint(0, 100), int)
assert_type(random_st.randint(100), int)
assert_type(random_st.randint([100]), npt.NDArray[np.lngg])
assert_type(random_st.randint(0, [100]), npt.NDArray[np.lngg])
...
assert_type(random_st.choice(5, 3), npt.NDArray[np.lngg])
assert_type(random_st.choice(5, 3, replace=True), npt.NDArray[np.lngg])
assert_type(random_st.choice(5, 3, p=[1 / 5] * 5), npt.NDArray[np.lngg])
assert_type(random_st.choice(5, 3, p=[1 / 5] * 5, replace=False), npt.NDArray[np.lngg])
...
assert_type(random_st.multinomial(20, [1 / 6.0] * 6), npt.NDArray[np.lngg])
assert_type(random_st.multinomial(20, np.array([0.5, 0.5])), npt.NDArray[np.lngg])
assert_type(random_st.multinomial(20, [1 / 6.0] * 6, size=2), npt.NDArray[np.lngg])
...
assert_type(random_st.permutation(10), npt.NDArray[np.lngg])
