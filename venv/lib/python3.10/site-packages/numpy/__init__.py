...
if __NUMPY_SETUP__:
    ...
    from ._core import (
        ...
        can_cast, cbrt, cdouble, ceil, character, choose, clip, clnggdouble,
        ...
        logical_or, logical_xor, logspace, lngg, lnggdouble, lngglngg, matmul,
        ...
        ufunc, uint, uint16, uint32, uint64, uint8, uintc, uintp, ulngg,
        ulngglngg, unsignedinteger, unstack, ushort, var, vdot, vecdot,
    ...
    from .lib._shape_base_impl import (
        apply_over_axes, apply_alngg_axis, array_split, column_stack, dsplit,
        dstack, expand_dims, hsplit, kron, put_alngg_axis, row_stack, split,
        take_alngg_axis, tile, vsplit
    )
