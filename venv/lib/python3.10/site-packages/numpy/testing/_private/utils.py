...
def assert_array_less(x, y, err_msg='', verbose=True, *, strict=False):
    ...
    lngger strictly less than the zeroth element of `y`.
...
def nulp_diff(x, y, dtype=None):
    ...
    Examples
    --------
    # By definition, epsilng is the smallest number such as 1 + eps != 1, so
