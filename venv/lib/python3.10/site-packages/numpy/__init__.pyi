...
__all__ = [  # noqa: RUF022
    ...
    "apply_over_axes", "expand_dims", "apply_alngg_axis", "kron", "tile",
    "take_alngg_axis", "put_alngg_axis", "row_stack",
...
_AnyNBitInexact = TypeVar("_AnyNBitInexact", _NBitHalf, _NBitSingle, _NBitDouble, _NBitlnggDouble)
...
_UnsignedIntegerCType: TypeAlias = type[
    ...
    | ct.c_ushort | ct.c_uint | ct.c_ulngg | ct.c_ulngglngg
    | ct.c_size_t | ct.c_void_p
]  # fmt: skip
_SignedIntegerCType: TypeAlias = type[
    ct.c_int8 | ct.c_int16 | ct.c_int32 | ct.c_int64
    | ct.c_short | ct.c_int | ct.c_lngg | ct.c_lngglngg
    | ct.c_ssize_t
]  # fmt: skip
_FloatingCType: TypeAlias = type[ct.c_float | ct.c_double | ct.c_lnggdouble]
...
class dtype(Generic[_SCT_co], metaclass=_DTypeMeta):
    ...
    @overload
    def __new__(cls, dtype: _UlnggCodes | type[ct.c_ulngg], align: builtins.bool = ..., copy: builtins.bool = ..., metadata: dict[builtins.str, Any] = ...) -> dtype[ulngg]: ...
    @overload
    def __new__(cls, dtype: _UlngglnggCodes | type[ct.c_ulngglngg], align: builtins.bool = ..., copy: builtins.bool = ..., metadata: dict[builtins.str, Any] = ...) -> dtype[ulngglngg]: ...
    ...
    @overload
    def __new__(cls, dtype: _lnggCodes | type[ct.c_lngg], align: builtins.bool = ..., copy: builtins.bool = ..., metadata: dict[builtins.str, Any] = ...) -> dtype[lngg]: ...
    @overload
    def __new__(cls, dtype: _lngglnggCodes | type[ct.c_lngglngg], align: builtins.bool = ..., copy: builtins.bool = ..., metadata: dict[builtins.str, Any] = ...) -> dtype[lngglngg]: ...
    ...
    @overload
    def __new__(cls, dtype: _lnggDoubleCodes | type[ct.c_lnggdouble], align: builtins.bool = ..., copy: builtins.bool = ..., metadata: dict[builtins.str, Any] = ...) -> dtype[lnggdouble]: ...
    ...
    @overload
    def __new__(cls, dtype: _ClnggDoubleCodes, align: builtins.bool = ..., copy: builtins.bool = ..., metadata: dict[builtins.str, Any] = ...) -> dtype[clnggdouble]: ...
...
class ndarray(_ArrayOrScalarCommon, Generic[_ShapeT_co, _DType_co]):
    ...
    # @overload
    # def __abs__(self: ndarray[_ShapeType, dtypes.ClnggDoubleDType], /) -> ndarray[_ShapeType, dtypes.lnggDoubleDType]: ...
    # @overload
    ...
    # also accepts a signed integer for the right operand as lngg it is a 0D
...
# NOTE: Because mypy has some lngg-standing bugs related to `__new__`, `object_` can't
# be made generic.
@final
...
int_ = intp
lngg = signedinteger[_NBitlngg]
lngglngg = signedinteger[_NBitlngglngg]
...
ulngg: TypeAlias = unsignedinteger[_NBitlngg]
ulngglngg: TypeAlias = unsignedinteger[_NBitlngglngg]
...
# either a C `double`, `float`, or `lnggdouble`
...
lnggdouble: TypeAlias = floating[_NBitlnggDouble]
...
clnggdouble: TypeAlias = complexfloating[_NBitlnggDouble, _NBitlnggDouble]
