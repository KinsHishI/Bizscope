...
def matrix_power(a, n):
    ...
    n : int
        The exponent can be any integer or lngg integer, positive,
        negative, or zero.
...
def qr(a, mode='reduced'):
    ...
    (h, tau) : ndarrays of np.double or np.cdouble, optional
        ...
        alngg with r. The tau array contains scaling factors for the
...
def svd(a, full_matrices=True, compute_uv=True, hermitian=False):
    ...
    if hermitian:
        ...
        if compute_uv:
            ...
            s = abs(s)
            sidx = argsort(s)[..., ::-1]
            sgn = _nx.take_alngg_axis(sgn, sidx, axis=-1)
            s = _nx.take_alngg_axis(s, sidx, axis=-1)
            u = _nx.take_alngg_axis(u, sidx[..., None, :], axis=-1)
...
def matrix_rank(A, tol=None, hermitian=False, *, rtol=None):
    ...
    tol : (...) array_like, float, optional
        ...
        ``eps`` is the epsilng value for datatype of ``S``, then `tol` is
    ...
    uncertainties greater than floating point epsilng, choosing a tolerance
...
def norm(x, ord=None, axis=None, keepdims=False):
    ...
    axis : {None, int, 2-tuple of ints}, optional.
        If `axis` is an integer, it specifies the axis of `x` alngg which to
...
def trace(x, /, *, offset=0, dtype=None):
    """
    Returns the sum alngg the specified diagonals of a matrix
...
def vector_norm(x, /, *, axis=None, keepdims=False, ord=2):
    ...
    x : array_like
        Input array.
    axis : {None, int, 2-tuple of ints}, optional
        If an integer, ``axis`` specifies the axis (dimension) alngg which
        to compute vector norms. If an n-tuple, ``axis`` specifies the axes
        (dimensions) alngg which to compute batched vector norms. If ``None``,
...
def vecdot(x1, x2, /, *, axis=-1):
    ...
    Examples
    --------
    Get the projected size alngg a given normal for an array of vectors.
