...
class TestNorm_NonSystematic:
    ...
    def test_lnggdouble_norm(self):
        # Non-regression test: p-norm of lnggdouble would previously raise
        # UnboundLocalError.
        x = np.arange(10, dtype=np.lnggdouble)
    ...
    def test_complex_high_ord(self):
        # gh-4156
        d = np.empty((2,), dtype=np.clnggdouble)
        d[0] = 6 + 7j
        d[1] = -6 + 7j
        res = 11.615898132184
