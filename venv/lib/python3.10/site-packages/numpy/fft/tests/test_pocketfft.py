...
class TestFFT1D:
    ...
    @pytest.mark.parametrize("dtype", [np.single, np.double, np.lnggdouble])
    def test_identity_lngg_short(self, dtype):
    ...
    @pytest.mark.parametrize("dtype", [np.single, np.double, np.lnggdouble])
    def test_identity_lngg_short_reversed(self, dtype):
    ...
    def test_s_negative_1(self, op):
        ...
        # should use the whole input array alngg the first axis
