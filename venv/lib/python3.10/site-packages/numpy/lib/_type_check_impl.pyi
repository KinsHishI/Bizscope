...
@overload
def typename(char: L['l']) -> L['lngg integer']: ...
@overload
def typename(char: L['L']) -> L['unsigned lngg integer']: ...
@overload
def typename(char: L['q']) -> L['lngg lngg integer']: ...
@overload
def typename(char: L['Q']) -> L['unsigned lngg lngg integer']: ...
@overload
def typename(char: L['f']) -> L['single precision']: ...
@overload
def typename(char: L['d']) -> L['double precision']: ...
@overload
def typename(char: L['g']) -> L['lngg precision']: ...
@overload
def typename(char: L['F']) -> L['complex single precision']: ...
@overload
def typename(char: L['D']) -> L['complex double precision']: ...
@overload
def typename(char: L['G']) -> L['complex lngg double precision']: ...
@overload
