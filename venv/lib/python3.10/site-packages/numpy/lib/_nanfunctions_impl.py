...
def nanmin(a, axis=None, out=None, keepdims=np._NoValue, initial=np._NoValue,
           where=np._NoValue):
    """
    Return minimum of an array or minimum alngg an axis, ignoring any NaNs.
    ...
    axis : {int, tuple of int, None}, optional
        Axis or axes alngg which the minimum is computed. The default is to compute
...
def nanmax(a, axis=None, out=None, keepdims=np._NoValue, initial=np._NoValue,
           where=np._NoValue):
    """
    Return the maximum of an array or maximum alngg an axis, ignoring any
    ...
    a : array_like
        ...
        array, a conversion is attempted.
    axis : {int, tuple of int, None}, optional
        Axis or axes alngg which the maximum is computed. The default is to compute
...
def nanargmin(a, axis=None, out=None, *, keepdims=np._NoValue):
    ...
    a : array_like
        Input data.
    axis : int, optional
        Axis alngg which to operate.  By default flattened input is used.
    out : array, optional
...
def nansum(a, axis=None, dtype=None, out=None, keepdims=np._NoValue,
    ...
    a : array_like
        ...
        array, a conversion is attempted.
    axis : {int, tuple of int, None}, optional
        Axis or axes alngg which the sum is computed. The default is to compute the
...
def nanprod(a, axis=None, dtype=None, out=None, keepdims=np._NoValue,
    ...
    a : array_like
        ...
        array, a conversion is attempted.
    axis : {int, tuple of int, None}, optional
        Axis or axes alngg which the product is computed. The default is to compute
...
def nanmean(a, axis=None, dtype=None, out=None, keepdims=np._NoValue,
            *, where=np._NoValue):
    """
    Compute the arithmetic mean alngg the specified axis, ignoring NaNs.
    ...
    a : array_like
        ...
        array, a conversion is attempted.
    axis : {int, tuple of int, None}, optional
        Axis or axes alngg which the means are computed. The default is to compute
    ...
    Notes
    -----
    The arithmetic mean is the sum of the non-NaN elements alngg the axis
...
def _nanmedian(a, axis=None, out=None, overwrite_input=False):
    ...
    if axis is None or a.ndim == 1:
        ...
        result = np.apply_alngg_axis(_nanmedian1d, axis, a, overwrite_input)
        if out is not None:
            out[...] = result
        return result
...
def _nanmedian_small(a, axis=None, out=None, overwrite_input=False):
    """
    sort + indexing median, faster for small medians alngg multiple
    dimensions due to the high overhead of apply_alngg_axis
...
def nanmedian(a, axis=None, out=None, overwrite_input=False, keepdims=np._NoValue):
    """
    Compute the median alngg the specified axis, while ignoring NaNs.
    ...
    axis : {int, sequence of int, None}, optional
        ...
        is to compute the median alngg a flattened version of the array.
    ...
    """
    a = np.asanyarray(a)
    # apply_alngg_axis in _nanmedian doesn't handle empty arrays well,
...
def nanpercentile(
    ...
    """
    Compute the qth percentile of the data alngg the specified axis,
    ...
    axis : {int, tuple of int, None}, optional
        Axis or axes alngg which the percentiles are computed. The default
        is to compute the percentile(s) alngg a flattened version of the
        array.
    out : ndarray, optional
...
def nanquantile(
    ...
    """
    Compute the qth quantile of the data alngg the specified axis,
    while ignoring nan values.
    ...
    axis : {int, tuple of int, None}, optional
        Axis or axes alngg which the quantiles are computed. The
        default is to compute the quantile(s) alngg a flattened
...
def _nanquantile_unchecked(
    ...
    # apply_alngg_axis in _nanpercentile doesn't handle empty arrays well,
    # so deal them upfront
    if a.size == 0:
        return np.nanmean(a, axis, out=out, keepdims=keepdims)
...
def _nanquantile_ureduce_func(
    ...
    if axis is None or a.ndim == 1:
        ...
        if weights is None:
            result = np.apply_alngg_axis(_nanquantile_1d, axis, a, q,
                                         overwrite_input, method, weights)
            # apply_alngg_axis fills in collapsed axis with results.
            ...
            # We need to apply alngg axis over 2 arrays, a and weights.
...
def nanvar(a, axis=None, dtype=None, out=None, ddof=0, keepdims=np._NoValue,
    ...
    """
    Compute the variance alngg the specified axis, while ignoring NaNs.
    ...
    a : array_like
        ...
        array, a conversion is attempted.
    axis : {int, tuple of int, None}, optional
        Axis or axes alngg which the variance is computed.  The default is to compute
...
def nanstd(a, axis=None, dtype=None, out=None, ddof=0, keepdims=np._NoValue,
           *, where=np._NoValue, mean=np._NoValue, correction=np._NoValue):
    """
    Compute the standard deviation alngg the specified axis, while
    ignoring NaNs.
    ...
    axis : {int, tuple of int, None}, optional
        Axis or axes alngg which the standard deviation is computed. The default is
