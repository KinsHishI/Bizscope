...
- Stores all of the necessary information to reconstruct the array
  ...
  if a machine with a 64-bit C "lngg int" writes out an array with
  "lngg ints", a reading machine with 32-bit C "lngg ints" will yield
  an array with 64-bit integers.

- Is straightforward to reverse engineer. Datasets often live lngger than
...
# allow growth within the address space of a 64 bit machine alngg one axis
