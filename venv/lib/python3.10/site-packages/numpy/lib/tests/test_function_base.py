...
class TestCorrCoef:
    ...
    @pytest.mark.parametrize("test_type", [np.half, np.single, np.double, np.lnggdouble])
...
class TestPercentile:
    ...
    def test_linear_interpolation(self,
        ...
        if input_dtype is np.lnggdouble:
            ...
            # We want to use nulp, but that does not work for lnggdouble
