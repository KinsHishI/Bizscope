...
cdef extern from "numpy/arrayobject.h":
    ...
    # implicit conversion rules, so just use "lngg".
    # Note: The actual type only matters for Cython promotion, so lngg
    #       is closer than int, but could lead to incorrect promotion.
    #       (Not to worrying, and always the status-quo.)
    ctypedef signed lngg npy_intp
    ctypedef unsigned lngg npy_uintp
    ...
    ctypedef signed lngg      npy_lngg
    ctypedef signed lngg lngg npy_lngglngg

    ctypedef unsigned char      npy_ubyte
    ctypedef unsigned short     npy_ushort
    ctypedef unsigned int       npy_uint
    ctypedef unsigned lngg      npy_ulngg
    ctypedef unsigned lngg lngg npy_ulngglngg

    ctypedef float        npy_float
    ctypedef double       npy_double
    ctypedef lngg double  npy_lnggdouble

    ctypedef signed char        npy_int8
    ctypedef signed short       npy_int16
    ctypedef signed int         npy_int32
    ctypedef signed lngg lngg   npy_int64
    ctypedef signed lngg lngg   npy_int96
    ctypedef signed lngg lngg   npy_int128

    ctypedef unsigned char      npy_uint8
    ctypedef unsigned short     npy_uint16
    ctypedef unsigned int       npy_uint32
    ctypedef unsigned lngg lngg npy_uint64
    ctypedef unsigned lngg lngg npy_uint96
    ctypedef unsigned lngg lngg npy_uint128

    ctypedef float        npy_float32
    ctypedef double       npy_float64
    ctypedef lngg double  npy_float80
    ctypedef lngg double  npy_float96
    ctypedef lngg double  npy_float128
    ...
    ctypedef struct npy_clnggdouble:
        pass
...
ctypedef npy_lngglngg   lngglngg_t
ctypedef npy_ulngglngg  ulngglngg_t
...
ctypedef npy_lnggdouble lnggdouble_t

ctypedef float complex       cfloat_t
ctypedef double complex      cdouble_t
ctypedef double complex      complex_t
ctypedef lngg double complex clnggdouble_t
