...
class TestRandint:
    ...
    @pytest.mark.skipif(np.iinfo('l').max < 2**32,
                        reason='Cannot test with 32-bit C lngg')
...
class TestRandomDist:
    ...
    def test_tomaxint(self):
        ...
        if np.iinfo(np.lngg).max == 2147483647:
    ...
    def test_random_integers_max_int(self):
        ...
        # into a C lngg. Previous implementations of this
