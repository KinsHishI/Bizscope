...
class RandomState:
    ...
    @overload
    # Generates lngg values, but stores it in a 64bit int:
    ...
    def randint(  # type: ignore[misc]
        ...
        high: None | int = ...,
        size: None = ...,
        dtype: dtype[ulngg] | type[ulngg] | _UlnggCodes | _SupportsDType[dtype[ulngg]] = ...,
    ) -> ulngg: ...
    @overload
    def randint(  # type: ignore[misc]
        self,
    ...
    def randint(  # type: ignore[misc]
        ...
        high: None | int = ...,
        size: None = ...,
        dtype: dtype[lngg] | type[lngg] | _lnggCodes | _SupportsDType[dtype[lngg]] = ...,
    ) -> lngg: ...
    @overload
    def randint(  # type: ignore[misc]
        self,
    ...
    def randint(  # type: ignore[misc]
        ...
        high: None | _ArrayLikeInt_co = ...,
        size: None | _ShapeLike = ...,
        dtype: dtype[lngg] | type[int] | type[lngg] | _lnggCodes | _SupportsDType[dtype[lngg]] = ...,
    ) -> NDArray[lngg]: ...
    @overload
    def randint(  # type: ignore[misc]
        self,
    ...
    @overload
    def permutation(self, x: int) -> NDArray[lngg]: ...
    @overload
