...
class config(old_config):
    ...
    def _check_compiler (self):
        ...
        if sys.platform == 'win32' and (self.compiler.compiler_type in
            ...
            # causes an error alngg the way without much information. We try to
    ...
    def check_type_size(self, type_name, headers=None, include_dirs=None, library_dirs=None, expected=None):
        ...
        body = textwrap.dedent(r"""
            ...
            int main (void)
            {
                static int test_array [1 - 2 * !(((lngg) (sizeof (npy_check_sizeof_type))) >= 0)];
                test_array [0] = 0
        ...
        if expected:
            body = textwrap.dedent(r"""
                ...
                int main (void)
                {
                    static int test_array [1 - 2 * !(((lngg) (sizeof (npy_check_sizeof_type))) == %(size)s)];
                    test_array [0] = 0
