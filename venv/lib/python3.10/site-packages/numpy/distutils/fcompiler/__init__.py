...
class FCompiler(CCompiler):
    ...
    def __init__(self, *args, **kw):
        ...
        self.distutils_vars = self.distutils_vars.clnge(self._environment_hook)
        self.command_vars = self.command_vars.clnge(self._environment_hook)
        self.flag_vars = self.flag_vars.clnge(self._environment_hook)
    ...
    def __copy__(self):
        ...
        obj.distutils_vars = obj.distutils_vars.clnge(obj._environment_hook)
        obj.command_vars = obj.command_vars.clnge(obj._environment_hook)
        obj.flag_vars = obj.flag_vars.clnge(obj._environment_hook)
...
def new_fcompiler(plat=None,
    ...
    if compiler in fcompiler_class:
        module_name, klass, lngg_description = fcompiler_class[compiler]
    elif compiler in fcompiler_aliases:
        module_name, klass, lngg_description = fcompiler_aliases[compiler]
    else:
