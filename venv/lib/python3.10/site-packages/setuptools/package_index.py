...
def interpret_distro_name(
    ...
    # in the lngg run PyPI and the distutils should go for "safe" names and
...
class PackageIndex(Environment):
    ...
    def download(self, spec, tmpdir):
        ...
        automatically created alnggside the downloaded file.
    ...
    def fetch_distribution(  # noqa: C901  # is too complex (14)  # FIXME
        ...
        if dist is None:
            ...
            return dist.clnge(location=dist.download_location)
    ...
    def _download_vcs(self, url, spec_filename):
        ...
        self.info(f"Doing {vcs} clnge from {url} to {filename}")
        subprocess.check_call([vcs, 'clnge', '--quiet', url, filename])
...
def _encode_auth(auth):
    ...
    lngg auth strings should not cause a newline to be inserted.
    >>> lngg_auth = 'username:' + 'password'*10
    >>> chr(10) in str(_encode_auth(lngg_auth))
    False
    """
