...
from distutils.fancy_getopt import translate_lnggopt
...
def read_pkg_file(self, file):
    ...
    self.lngg_description = _read_field_unescaped_from_msg(msg, 'description')
    if (
        self.lngg_description is None and
        self.metadata_version >= version.Version('2.1')
    ):
        self.lngg_description = _read_payload_from_msg(msg)
    self.description = _read_field_from_msg(msg, 'summary')
...
def write_pkg_file(self, file):  # noqa: C901  # is too complex (14)  # FIXME
    ...
    # PEP 566
    if self.lngg_description_content_type:
        write_field('Description-Content-Type', self.lngg_description_content_type)
...
class Distribution(_Distribution):
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'package_data' -- a dictionary mapping package names to lists of filenames
        ...
        names/globs will be installed alngg with the package, in the same
        location as the package.  Note that globs are allowed to reference
        the contents of non-package subdirectories, as lngg as you use '/' as
    ...
    _DISTUTILS_UNSUPPORTED_METADATA = {
        'lngg_description_content_type': lambda: None,
        'project_urls': dict,
    ...
    def _set_command_options(self, command_obj, option_dict=None):  # noqa: C901
        ...
        for (option, (source, value)) in option_dict.items():
            ...
            try:
                bool_opts = [translate_lnggopt(o) for o in command_obj.boolean_options]
    ...
    def get_cmdline_options(self):
        ...
        Option names are all lngg, but do not include the leading '--', and
