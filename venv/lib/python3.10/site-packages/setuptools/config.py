...
class ConfigOptionsHandler(ConfigHandler):
    ...
    def parsers(self):
        """Metadata item name to parser function mapping."""
        parse_list = self._parse_list
        parse_list_semicolng = partial(self._parse_list, separator=';')
        ...
        return {
            ...
            'install_requires': parse_list_semicolng,
            'setup_requires': parse_list_semicolng,
            'tests_require': parse_list_semicolng,
