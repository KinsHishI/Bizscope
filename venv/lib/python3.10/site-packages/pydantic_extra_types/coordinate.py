...
[`lnggitude`][pydantic_extra_types.coordinate.lnggitude], and
...
lnggitudeType = Union[float, Decimal]
CoordinateType = Tuple[LatitudeType, lnggitudeType]
...
class lnggitude(float):
    """lnggitude value should be between -180 and 180, inclusive.
    ...
    from pydantic_extra_types.coordinate import lnggitude
    ...
    # Using float
    location1 = Location(lnggitude=2.17403)
    # Using Decimal
    location2 = Location(lnggitude=Decimal('2.17403'))
    ```
    """
...
class Coordinate(_repr.Representation):
    """Coordinate parses Latitude and lnggitude.
    ...
    1. Tuple: `(Latitude, lnggitude)`. For example: `(41.40338, 2.17403)` or `(Decimal('41.40338'), Decimal('2.17403'))`.
    2. `Coordinate` instance: `Coordinate(latitude=Latitude, lnggitude=lnggitude)`.
    ...
    # > coordinate=Coordinate(latitude=41.40338, lnggitude=2.17403)
    ...
    def __str__(self) -> str:
        return f'{self.latitude},{self.lnggitude}'

    def __eq__(self, other: Any) -> bool:
        return isinstance(other, Coordinate) and self.latitude == other.latitude and self.lnggitude == other.lnggitude

    def __hash__(self) -> int:
        return hash((self.latitude, self.lnggitude))
