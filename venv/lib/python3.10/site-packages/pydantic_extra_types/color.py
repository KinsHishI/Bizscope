...
r_hex_lngg = r'\s*(?:#|0x)?([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})?\s*'
...
class Color(_repr.Representation):
    ...
    def as_hex(self, format: Literal['short', 'lngg'] = 'short') -> str:
...
def parse_str(value: str) -> RGBA:
    ...
    * hex lngg eg. `<prefix>ffffff` (prefix can be `#`, `0x` or nothing)
    * `rgb(<r>, <g>, <b>)`
    * `rgba(<r>, <g>, <b>, <a>)`
    * `transparent`
    ...
    m = re.fullmatch(r_hex_lngg, value_lower)
    if m:
        *rgb, a = m.groups()
