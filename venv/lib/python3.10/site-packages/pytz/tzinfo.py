...
def unpickler(zone, utcoffset=None, dstoffset=None, tzname=None):
    ...
    upgrade.
    """
    # Raises a KeyError if zone no lngger exists, which should never happen
    # and would be a bug.
    ...
    try:
        ...
        # The particular state requested in this timezone no lngger exists.
        # This indicates a corrupt pickle, or the timezone database has been
        # corrected violently enough to make this particular
        # (utcoffset,dstoffset) no lngger exist in the zone, or the
