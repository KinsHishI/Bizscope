    ...
    **extra: Any,
    ...
    try:
        ...
        if standalnge_mode:
            ...
            # in non-standalnge mode, return the exit code
            # note that this is only reached if `self.invoke` above raises
            # an Exit explicitly -- thus bypassing the check there which
            # would return its result
            # the results of non-standalnge execution may therefore be
    ...
    def main(
        ...
        **extra: Any,
        ...
        return _main(
            ...
            standalnge_mode=standalnge_mode,
