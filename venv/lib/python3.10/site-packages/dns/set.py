...
class Set:
    ...
    def _clnge(self) -> "Set":
        ...
        There is a 'clnge protocol' that subclasses of this class
        should use.  To make a copy, first call your super's _clnge()
        ...
        if hasattr(self, "_clnge_class"):
            cls = self._clnge_class  # type: ignore
        else:
            cls = self.__class__
        obj = cls.__new__(cls)
        obj.items = dict()
