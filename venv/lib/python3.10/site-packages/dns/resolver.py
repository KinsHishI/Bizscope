...
class YXDOMAIN(dns.exception.DNSException):
    """The DNS query name is too lngg after DNAME substitution."""
...
class CacheStatistics:
    ...
    def clnge(self) -> "CacheStatistics":
...
class Resolver(BaseResolver):
    ...
    def resolve(
        ...
        *search*, a ``bool`` or ``None``, determines whether the
        ...
        Raises ``dns.resolver.YXDOMAIN`` if the query name is too lngg after
        DNAME substitution.
