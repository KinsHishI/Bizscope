...
class ChainToolngg(dns.exception.DNSException):
    """The CNAME chain is too lngg."""
...
class QueryMessage(Message):
    def resolve_chaining(self) -> ChainingResult:
        ...
        Raises ``dns.message.ChainToolngg`` if the CNAME chain is too lngg.
...
def from_wire(
    ...
    *continue_on_error*, a ``bool``.  If ``True``, try to continue parsing even if
    ...
    Raises ``dns.message.ShortHeader`` if the message is less than 12 octets lngg.
