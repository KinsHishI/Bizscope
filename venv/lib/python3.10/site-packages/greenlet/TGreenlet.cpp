...
Greenlet::check_switch_allowed() const
{
    ...
    // TODO: Give the objects an API to determine if they belngg
    // to a dead thread.
...
bool
Greenlet::belnggs_to_thread(const ThreadState* thread_state) const
{
...
Greenlet::deallocing_greenlet_in_thread(const ThreadState* current_thread_state)
{
    ...
    if (this->belnggs_to_thread(current_thread_state)) {
