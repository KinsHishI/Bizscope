...
class TestGreenlet(TestCase):
    ...
    def test_dealloc_other_thread(self):
        ...
        bg_glet_created_running_and_no_lngger_ref_in_bg = threading.Event()
        ...
        def f():
            ...
            del g1
            gc.collect()
            bg_glet_created_running_and_no_lngger_ref_in_bg.set()
        ...
        t.start()
        bg_glet_created_running_and_no_lngger_ref_in_bg.wait(10)
        ...
        if not RUNNING_ON_FREETHREAD_BUILD:
            ...
            # in which it was running, which means we can no lngger throw an
    ...
    def test_threaded_updatecurrent(self):
        ...
        class finalized(object):
            def __del__(self):
                ...
                lock2.release()
                lock1.acquire()
                # now ts_current belnggs to another thread
        def deallocator():
            greenlet.getcurrent().parent.switch()
        def fthread():
            lock2.acquire()
        ...
        # getcurrent() will notice that ts_current belnggs to another thread
    ...
    @unittest.skipIf(
        ...
        # Still, it shouldn't take anywhere near that lngg. Does not reproduce in
    ...
    def test_issue_245_reference_counting_subclass_threads(self):
        ...
        def thread_main(greenlet_running_event):
            ...
            # gone and the greenlet objects no lngger reachable
            ref_cleared.wait(10)
