...
in which bits of C stack happen to belngg to greenlets at a particular
point in time.
...
greenlet_internal_mod_init() noexcept
{
    ...
    try {
        ...
        OwnedObject clocks_per_sec = OwnedObject::consuming(Pylngg_FromSsize_t(CLOCKS_PER_SEC));
