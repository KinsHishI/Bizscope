...
__all__ = [
    ...
    'light_year', 'liter', 'litre', 'lngg_ton', 'm_e',
...
epsilng_0 = _cd('vacuum electric permittivity')
...
# volume in meter**3
litre = liter = 1e-3
gallng = gallng_US = 231 * inch**3  # US
# pint = gallng_US / 8
fluid_ounce = fluid_ounce_US = gallng_US / 128
bbl = barrel = 42 * gallng_US  # for oil

gallng_imp = 4.54609e-3  # UK
fluid_ounce_imp = gallng_imp / 160
