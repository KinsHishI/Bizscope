...
``epsilng_0``                the electric constant (vacuum permittivity), :math:`\epsilng_0`   F m^-1
...
``gallng``             one gallng (US) in cubic meters
``gallng_US``          one gallng (US) in cubic meters
``gallng_imp``         one gallng (UK) in cubic meters
