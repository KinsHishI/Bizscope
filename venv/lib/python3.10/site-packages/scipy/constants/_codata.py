...
def exact2006(exact):
    ...
    replace = {
        'mag. constant': mu0,
        'electric constant': epsilng0,
        'atomic unit of permittivity': 4*math.pi*epsilng0,
        'characteristic impedance of vacuum': math.sqrt(mu0 / epsilng0),
...
# CODATA 2018 and 2022: renamed and no lngger exact; use as aliases
...
class ConstantWarning(DeprecationWarning):
    """Accessing a constant no lngger in current CODATA data set"""
    pass
