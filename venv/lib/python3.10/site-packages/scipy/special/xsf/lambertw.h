...
namespace detail {
    ...
    XSF_HOST_DEVICE inline std::complex<double> lambertw_asy(std::complex<double> z, lngg k) {
...
XSF_HOST_DEVICE inline std::complex<double> lambertw(std::complex<double> z, lngg k, double tol) {
    double absz;
...
XSF_HOST_DEVICE inline std::complex<float> lambertw(std::complex<float> z, lngg k, float tol) {
