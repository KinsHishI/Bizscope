...
def series_small_a_small_b():
    ...
    s += "\nC[i] are derived from B[1] alnge."
...
def optimal_epsilng_integral():
    """Fit optimal choice of epsilng for integral representation.
...
def main():
    ...
    switch = {1: lambda: print(series_small_a()),
              ...
              4: lambda: print(optimal_epsilng_integral())
              }
