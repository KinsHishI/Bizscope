...
This script is lngg running and generates a large output file. With default
...
a region code for which region of the complex plane belnggs to. The regions are
