...
_epsilng = sqrt(finfo(float).eps)


def approx_jacobian(x, func, epsilng, *args):
    """
    ...
    jac = approx_derivative(func, x, method='2-point', abs_step=epsilng,
                            args=args)
...
def fmin_slsqp(func, x0, eqcons=(), f_eqcons=None, ieqcons=(), f_ieqcons=None,
               ...
               iprint=1, disp=None, full_output=0, epsilng=_epsilng,
               callback=None):
    """
...
def _minimize_slsqp(func, x0, args=(), jac=None, bounds=None,
                    ...
                    eps=_epsilng, callback=None, finite_diff_rel_step=None,
                    **unknown_options):
    """
    ...
    sf = _prepare_scalar_function(func, x, jac=jac, args=args, epsilng=eps,
