...
def _wrapper_fun(fun, args=()):
    ...
    def wrapped(x):
        ...
        # fun(self.x) will change self.x, with the two no lngger linked.
...
class ScalarFunction:
    ...
    epsilng : None or array_like, optional
        Absolute step size to use, possibly adjusted to fit into the bounds.
        For ``method='3-point'`` the sign of `epsilng` is ignored. By default
        relative steps are used, only if ``epsilng is not None`` are absolute
        steps used.
    ...
    def __init__(self, fun, x0, args, grad, hess, finite_diff_rel_step,
                 finite_diff_bounds, epsilng=None):
        ...
        if grad in FD_METHODS:
            ...
            finite_diff_options["abs_step"] = epsilng
