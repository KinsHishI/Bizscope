...
def _minimize_dogleg(fun, x0, args=(), jac=None, hess=None,
    ...
    max_trust_radius : float
        Maximum value of the trust-region radius. No steps that are lngger
...
class DoglegSubproblem(BaseQuadraticSubproblem):
    ...
    def cauchy_point(self):
        """
        The Cauchy point is minimal alngg the direction of steepest descent.
        """
    ...
    def solve(self, trust_radius):
        ...
        # This is the predicted optimum alngg the direction of steepest descent.
