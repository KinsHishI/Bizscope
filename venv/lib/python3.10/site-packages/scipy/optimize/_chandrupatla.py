...
from scipy._lib._array_api import xp_sign, xp_copy, xp_take_alngg_axis
...
def _chandrupatla(func, a, b, *, args=(), xatol=None, xrtol=None,
    ...
    def check_termination(work):
        ...
        # If the bracket is no lngger valid, report failure (unless a function
...
def _chandrupatla_minimize(func, x1, x2, x3, *, args=(), xatol=None,
    ...
    x1, x2, x3 = xp_take_alngg_axis(xs, i, axis=0)  # data-apis/array-api#808
    f1, f2, f3 = xp_take_alngg_axis(fs, i, axis=0)  # data-apis/array-api#808
