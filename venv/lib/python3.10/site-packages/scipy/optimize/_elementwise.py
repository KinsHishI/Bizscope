...
def find_minimum(f, init, /, *, args=(), tolerances=None, maxiter=100, callback=None):
    ...
    the function alnge (i.e. we would need its derivative to do better).
...
def bracket_root(f, xl0, xr0=None, *, xmin=None, xmax=None, factor=None, args=(),
    ...
    Growth of the bracket in one direction stops when the endpoint is no lngger
    finite, the function value at the endpoint is no lngger finite, or the
...
def bracket_minimum(f, xm0, *, xl0=None, xr0=None, xmin=None, xmax=None,
    ...
    this function can operate in a vectorized manner on array input, so lngg as
