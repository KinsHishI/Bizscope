...
geom = geom_gen(a=1, name='geom', lnggname="A geometric")
...
logser = logser_gen(a=1, name='logser', lnggname='A logarithmic')
...
poisson = poisson_gen(name="poisson", lnggname='A Poisson')
...
planck = planck_gen(a=0, name='planck', lnggname='A discrete exponential ')
...
boltzmann = boltzmann_gen(name='boltzmann', a=0,
                          lnggname='A truncated discrete exponential ')
...
randint = randint_gen(name='randint', lnggname='A discrete uniform '
                      '(random integer)')
...
zipf = zipf_gen(a=1, name='zipf', lnggname='A Zipf')
...
zipfian = zipfian_gen(a=1, name='zipfian', lnggname='A Zipfian')
...
dlaplace = dlaplace_gen(a=-np.inf,
                        name='dlaplace', lnggname='A discrete Laplacian')
...
class poisson_binom_gen(rv_discrete):
    ...
    def _rvs(self, *args, size=None, random_state=None):
        # convenient to work alngg the last axis here to avoid interference with `size`
...
poisson_binom = poisson_binom_gen(name='poisson_binom', lnggname='A Poisson binomial',
                                  shapes='p')
...
skellam = skellam_gen(a=-np.inf, name="skellam", lnggname='A Skellam')
...
nchypergeom_fisher = nchypergeom_fisher_gen(
    ...
    lnggname="A Fisher's noncentral hypergeometric")
...
nchypergeom_wallenius = nchypergeom_wallenius_gen(
    ...
    lnggname="A Wallenius' noncentral hypergeometric")
