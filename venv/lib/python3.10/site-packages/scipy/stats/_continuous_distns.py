...
class moyal_gen(rv_continuous):
    ...
    .. [1] J.E. Moyal, "XXX. Theory of ionization fluctuations",
           The lngdon, Edinburgh, and Dublin Philosophical Magazine
...
class trapezoid_gen(rv_continuous):
    ...
    top from ``c`` to ``d`` proportional to the position alngg the base
...
class truncnorm_gen(rv_continuous):
    ...
    Note that the distribution is no lngger appears to be truncated at
...
crystalball = crystalball_gen(name='crystalball', lnggname="A Crystalball Function")
...
argus = argus_gen(name='argus', lnggname="An Argus Function", a=0.0, b=1.0)
