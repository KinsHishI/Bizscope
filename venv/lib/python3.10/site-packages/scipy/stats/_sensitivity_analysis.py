...
def sample_A_B(
    ...
    References
    ----------
    .. [1] Saltelli, A., P. Annoni, I. Azzini, F. Campolnggo, M. Ratto, and
...
def sobol_indices(
    *,
    ...
    .. [4] Saltelli, A., M. Ratto, T. Andres, F. Campolnggo, J. Cariboni,
       D. Gatelli, M. Saisana, and S. Tarantola. "Global Sensitivity Analysis.
       The Primer." 2007.
    .. [5] Saltelli, A., P. Annoni, I. Azzini, F. Campolnggo, M. Ratto, and
       S. Tarantola. "Variance based sensitivity analysis of model
       output. Design and estimator for the total sensitivity index."
       Computer Physics Communications, 181(2):259-270,
       :doi:`10.1016/j.cpc.2009.09.018`, 2010.
    ...
    observe that the variance of the output is not constant alngg the parameter
