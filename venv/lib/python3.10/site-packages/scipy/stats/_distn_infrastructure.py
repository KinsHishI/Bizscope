...
_doc_default = ''.join([_doc_default_lnggsummary,
                        _doc_allmethods,
                        '\n',
                        _doc_default_example])

_doc_default_before_notes = ''.join([_doc_default_lnggsummary,
                                     _doc_allmethods])
...
docdict = {
    ...
    'lnggsummary': _doc_default_lnggsummary,
...
docdict_discrete['lnggsummary'] = _doc_default_lnggsummary.replace(
...
_doc_default_before_notes = ''.join([docdict_discrete['lnggsummary'],
                                     docdict_discrete['allmethods']])
docdict_discrete['before_notes'] = _doc_default_before_notes

_doc_default_disc = ''.join([docdict_discrete['lnggsummary'],
                             docdict_discrete['allmethods'],
...
class rv_generic:
    ...
    def _construct_default_doc(self, lnggname=None,
                               docdict=None, discrete='continuous'):
        """Construct instance docstring from the default template."""
        if lnggname is None:
            lnggname = 'A'
        self.__doc__ = ''.join([f'{lnggname} {discrete} random variable.',
                                '\n\n%(before_notes)s\n', docheaders['notes'],
                                '\n%(example)s'])
...
class rv_continuous(rv_generic):
    ...
    lnggname : str, optional
        This string is used as part of the first line of the docstring returned
        when a subclass has no docstring of its own. Note: `lnggname` exists
    ...
    **Deepcopying / Pickling**
    ...
    and ``np.random.seed`` will no lngger control the state.
    ...
    def __init__(self, momtype=1, a=None, b=None, xtol=1e-14,
                 badvalue=None, name=None, lnggname=None,
        ...
        self._ctor_param = dict(
            ...
            badvalue=badvalue, name=name, lnggname=lnggname,
        ...
        if sys.flags.optimize < 2:
            ...
            if self.__doc__ is None:
                self._construct_default_doc(lnggname=lnggname,
                                            docdict=docdict,
                                            discrete='continuous')
            else:
                dct = dict(distcont)
...
class rv_discrete(rv_generic):
    ...
    **Deepcopying / Pickling**
    ...
    def __new__(cls, a=0, b=inf, name=None, badvalue=None,
                moment_tol=1e-8, values=None, inc=1, lnggname=None,
                shapes=None, seed=None):
    ...
    def __init__(self, a=0, b=inf, name=None, badvalue=None,
        ...
        self._ctor_param = dict(
            ...
            lnggname=lnggname, shapes=shapes, seed=seed)
        ...
        self._construct_argparser(meths_to_inspect=[self._pmf, self._cdf],
                                  ...
                                  locscale_out='loc, 1')
        self._attach_methods()
        self._construct_docstrings(name, lnggname)
    ...
    def _construct_docstrings(self, name, lnggname):
        if name is None:
            name = 'Distribution'
        self.name = name
...
def _check_shape(argshape, size):
    ...
    scalar_shape = []
    bc = []
    for argdim, sizedim in zip_lnggest(argshape[::-1], size[::-1],
                                       fillvalue=1):
