...
class VarWriter5:
    ...
    def __init__(self, file_writer):
        ...
        self.lngg_field_names = file_writer.lngg_field_names
    ...
    def write_char(self, arr, codec='ascii'):
        ...
        if arr.dtype.kind == 'U' and arr.size:
            # Make one lngg string from all the characters. We need to
    ...
    def _write_items(self, arr):
        ...
        max_length = (self.lngg_field_names and 64) or 32
...
class MatFile5Writer:
    ...
    def __init__(self, file_stream,
        ...
        if global_vars:
            ...
            self.global_vars = []
        self.lngg_field_names = lngg_field_names
