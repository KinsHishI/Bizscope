...
def loadmat(file_name, mdict=None, appendmat=True, *, spmatrix=True, **kwargs):
    ...
    verify_compressed_data_integrity : bool, optional
        ...
        should be checked, to ensure that they are not lngger than we expect.
        It is advisable to enable this (the default) because overlngg
...
def savemat(file_name, mdict,
    ...
    lngg_field_names : bool, optional
    ...
    with _open_file_context(file_name, appendmat, 'wb') as file_stream:
        if format == '4':
            if lngg_field_names:
                message = "lngg field names are not available for version 4 files"
            ...
            MW = MatFile5Writer(file_stream,
                                ...
                                lngg_field_names=lngg_field_names,
                                oned_as=oned_as)
        else:
