...
class netcdf_file:
    ...
    mmap : None or bool, optional
        ...
        file cannot be closed as lngg as references to it exist.
    ...
    uses and any attributes such as data units, alngg with containing the data
    ...
    latitude, lnggitude and time. If one wants to add more temperature data to
...
class netcdf_variable:
    ...
    def isrec(self):
        ...
        A record dimension is a dimension alngg which additional data could be
