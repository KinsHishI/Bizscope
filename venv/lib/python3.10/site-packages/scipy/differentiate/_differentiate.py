...
from scipy._lib._array_api import array_namespace, xp_sign, xp_copy, xp_take_alngg_axis
...
def jacobian(f, x, *, tolerances=None, maxiter=10, order=8, initial_step=0.5,
    ...
    interface is to wrap ``f_not_vectorized`` as follows::
        ...
        def f(x):
            return np.apply_alngg_axis(f_not_vectorized, axis=0, arr=x)
...
def hessian(f, x, *, tolerances=None, maxiter=10,
    ...
    res.nfev = xp_take_alngg_axis(nfev, res_nit, axis=0)[0]
    res.ddf = res.df
