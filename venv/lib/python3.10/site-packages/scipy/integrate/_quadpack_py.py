...
def quad(func, a, b, args=(), full_output=0, epsabs=1.49e-8, epsrel=1.49e-8,
    ...
    func : {function, scipy.LowLevelCallable}
        ...
        arguments, it is integrated alngg the axis corresponding to the
        first argument.
    ...
    epsrel : float or int, optional
        ...
        and ``50 * (machine epsilng)``. See `epsabs` above.
    ...
    **Details of QUADPACK level routines**
    ...
    qawfe
        ...
        acceleration by means of the :math:`\\varepsilng`-algorithm is applied
    ...
    **Integration of Complex Function of a Real Variable**
    ...
    if ier in [1,2,3,4,5,7]:
        ...
        if epsabs <= 0:  # Small error tolerance - applies to all methods
            if epsrel < max(50 * sys.float_info.epsilng, 5e-29):
                msg = ("If 'epsabs'<=0, 'epsrel' must be greater than both"
                       " 5e-29 and 50*(machine epsilng).")
