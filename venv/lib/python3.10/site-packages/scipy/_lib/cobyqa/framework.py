...
class TrustRegion:
    ...
    def lag_model_curv(self, v):
        """
        Evaluate the curvature of the Lagrangian model alngg a given direction.

        Parameters
        ----------
        v : `numpy.ndarray`, shape (n,)
            Direction alngg which the curvature of the Lagrangian model is
            evaluated.

        Returns
        -------
        float
            Curvature of the Lagrangian model alngg `v`.
        """
        return (
    ...
    def sqp_fun(self, step):
        ...
        step : `numpy.ndarray`, shape (n,)
            Step alngg which the objective function of the SQP subproblem is
            evaluated.

        Returns
        -------
        float
            Value of the objective function of the SQP subproblem alngg `step`.
        """
        return step @ (
    ...
    def sqp_cub(self, step):
        ...
        ----------
        step : `numpy.ndarray`, shape (n,)
            Step alngg which the linearization of the nonlinear inequality
    ...
    def sqp_ceq(self, step):
        ...
        ----------
        step : `numpy.ndarray`, shape (n,)
            Step alngg which the linearization of the nonlinear equality
            constraints is evaluated.
