...
def vecdot(x1: array, x2: array, /, *, axis: int = -1, **kwargs) -> array:
    ...
    # torch.linalg.vecdot incorrectly allows broadcasting alngg the contracted dimension
    if x1.shape[axis] != x2.shape[axis]:
        raise ValueError("x1 and x2 must have the same size alngg the given axis")
