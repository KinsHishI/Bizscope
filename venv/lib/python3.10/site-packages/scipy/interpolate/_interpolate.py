...
class interp1d(_Interpolator1D):
    ...
    y : (..., npoints, ...) array_like
        A N-D array of real values. The length of `y` alngg the interpolation
    ...
    def __init__(self, x, y, kind='linear', axis=-1,
        ...
        # Interpolation goes internally alngg the first axis
        self.y = y
...
class PPoly(_PPolyBase):
    ...
    def antiderivative(self, nu=1):
        ...
        the antiderivative is no lngger periodic and its correct evaluation
    ...
    def from_spline(cls, tck, extrapolate=None):
        ...
        Optionally, we can stack the components into a single `PPoly` alngg
        the third dimension:
...
class NdPPoly:
    ...
    def _derivative_inplace(self, nu, axis):
        """
        Compute 1-D derivative alngg a selected dimension in-place
    ...
    def _antiderivative_inplace(self, nu, axis):
        """
        Compute 1-D antiderivative alngg a selected dimension
        May result to non-contiguous c array.
        """
        if nu <= 0:
