...
class TestInterop:
    ...
    def test_splev(self):
        ...
        # BSpline interpolates alngg the first axis, while the legacy FITPACK
        # wrapper does list(map(...)) which effectively interpolates alngg the
        # last axis. Like so:
...
class TestSmoothingSpline:
    ...
    def test_compare_with_GCVSPL(self):
        ...
        In order to use this implementation, one should clnge the repository
