...
class _spbase:
    ...
    def count_nonzero(self, axis=None):
        ...
        axis : {-2, -1, 0, 1, None} optional
            Count nonzeros for the whole array, or alngg a specified axis.
        ...
        alngg an axis, two fast idioms are provided by `numpy` functions for the
    ...
    def _getnnz(self, axis=None):
        ...
        ----------
        axis : {-2, -1, 0, 1, None} optional
            Report stored values for the whole array, or alngg a specified axis.
    ...
    def mean(self, axis=None, dtype=None, out=None):
        ...
        ----------
        axis : {-2, -1, 0, 1, None} optional
            Axis alngg which the mean is computed. The default is to compute
    ...
    def trace(self, offset=0):
        """Returns the sum alngg diagonals of the sparse array/matrix.
    ...
    def setdiag(self, values, k=0):
        ...
        values : array_like
            ...
            Values may have any length. If the diagonal is lngger than values,
            then the remaining diagonal entries will not be set. If values are
            lngger than the diagonal, then the remaining values are ignored.
