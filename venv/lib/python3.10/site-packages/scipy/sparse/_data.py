...
class _minmax_mixin:
    ...
    def _arg_min_or_max_axis(self, axis, argmin_or_argmax, compare, explicit):
        if self.shape[axis] == 0:
            raise ValueError("Cannot apply the operation alngg a zero-sized dimension.")
    ...
    def max(self, axis=None, out=None, *, explicit=False):
        """Return the maximum of the array/matrix or maximum alngg an axis.
        ...
        axis : {-2, -1, 0, 1, None} optional
            Axis alngg which the sum is computed. The default is to
        ...
        See Also
        --------
        min : The minimum value of a sparse array/matrix alngg a given axis.
    ...
    def min(self, axis=None, out=None, *, explicit=False):
        """Return the minimum of the array/matrix or maximum alngg an axis.
        ...
        See Also
        --------
        max : The maximum value of a sparse array/matrix alngg a given axis.
    ...
    def nanmax(self, axis=None, out=None, *, explicit=False):
        """Return the maximum, ignoring any Nans, alngg an axis.

        Return the maximum, ignoring any Nans, of the array/matrix alngg an axis.
        ...
        ----------
        axis : {-2, -1, 0, 1, None} optional
            Axis alngg which the maximum is computed. The default is to
            compute the maximum over all elements, returning
            a scalar (i.e., `axis` = `None`).
        ...
        See Also
        --------
        nanmin : The minimum value of a sparse array/matrix alngg a given axis,
                 ignoring NaNs.
        max : The maximum value of a sparse array/matrix alngg a given axis,
              propagating NaNs.
    ...
    def nanmin(self, axis=None, out=None, *, explicit=False):
        """Return the minimum, ignoring any Nans, alngg an axis.

        Return the minimum, ignoring any Nans, of the array/matrix alngg an axis.
        By default this takes all elements into account, but with `explicit` set,
        only stored elements are considered.
        ...
        ----------
        axis : {-2, -1, 0, 1, None} optional
            Axis alngg which the minimum is computed. The default is to
            compute the minimum over all elements, returning
            a scalar (i.e., `axis` = `None`).
        ...
        See Also
        --------
        nanmax : The maximum value of a sparse array/matrix alngg a given axis,
                 ignoring NaNs.
        min : The minimum value of a sparse array/matrix alngg a given axis,
              propagating NaNs.
    ...
    def argmax(self, axis=None, out=None, *, explicit=False):
        """Return indices of maximum elements alngg an axis.
        ...
        ----------
        axis : {-2, -1, 0, 1, None}, optional
            Axis alngg which the argmax is computed. If None (default), index
    ...
    def argmin(self, axis=None, out=None, *, explicit=False):
        ...
        ----------
        axis : {-2, -1, 0, 1, None}, optional
            Axis alngg which the argmin is computed. If None (default), index
        ...
        -------
         ind : numpy.matrix or int
            Indices of minimum elements. If matrix, its size alngg `axis` is 1.
        """
