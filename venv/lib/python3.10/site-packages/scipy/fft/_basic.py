...
def fft(x, n=None, axis=-1, norm=None, overwrite_x=False, workers=None, *,
    ...
    n : int, optional
        ...
        the length of the input alngg the axis specified by `axis` is used.
    axis : int, optional
    ...
    -------
    out : complex ndarray
        The truncated or zero-padded input, transformed alngg the axis
    ...
    Transforms can be done in single, double, or extended precision (lngg
...
def rfft(x, n=None, axis=-1, norm=None, overwrite_x=False, workers=None, *,
    ...
    x : array_like
        Input array
    n : int, optional
        Number of points alngg transformation axis in the input to use.
        If `n` is smaller than the length of the input, the input is cropped.
        If it is larger, the input is padded with zeros. If `n` is not given,
        the length of the input alngg the axis specified by `axis` is used.
    axis : int, optional
...
def irfft(x, n=None, axis=-1, norm=None, overwrite_x=False, workers=None, *,
    ...
    n : int, optional
        ...
        input is lngger than this, it is cropped. If it is shorter than this,
        it is padded with zeros. If `n` is not given, it is taken to be
        ``2*(m-1)``, where ``m`` is the length of the input alngg the axis
        specified by `axis`.
    axis : int, optional
...
def hfft(x, n=None, axis=-1, norm=None, overwrite_x=False, workers=None, *,
    ...
    n : int, optional
        ...
        lngger than this, it is cropped. If it is shorter than this, it is
        padded with zeros. If `n` is not given, it is taken to be ``2*(m-1)``,
        where ``m`` is the length of the input alngg the axis specified by
        `axis`.
    axis : int, optional
...
def ihfft(x, n=None, axis=-1, norm=None, overwrite_x=False, workers=None, *,
    ...
    x : array_like
        Input array.
    n : int, optional
        Length of the inverse FFT, the number of points alngg
        transformation axis in the input to use.  If `n` is smaller than
        the length of the input, the input is cropped. If it is larger,
        the input is padded with zeros. If `n` is not given, the length of
        the input alngg the axis specified by `axis` is used.
    axis : int, optional
        Axis over which to compute the inverse FFT. If not given, the last
        axis is used.
    norm : {"backward", "ortho", "forward"}, optional
...
def fftn(x, s=None, axes=None, norm=None, overwrite_x=False, workers=None, *,
    ...
    s : sequence of ints, optional
        ...
        Alngg any axis, if the given shape is smaller than that of the input,
        the input is cropped. If it is larger, the input is padded with zeros.
        if `s` is not given, the shape of the input alngg the axes specified
        by `axes` is used.
    ...
    -------
    out : complex ndarray
        The truncated or zero-padded input, transformed alngg the axes
...
def ifftn(x, s=None, axes=None, norm=None, overwrite_x=False, workers=None, *,
    ...
    the input alngg the specified dimension. Although this is the common
...
def fft2(x, s=None, axes=(-2, -1), norm=None, overwrite_x=False, workers=None, *,
    ...
    s : sequence of ints, optional
        ...
        (``s[0]`` refers to axis 0, ``s[1]`` to axis 1, etc.).
        This corresponds to ``n`` for ``fft(x, n)``.
        Alngg each axis, if the given shape is smaller than that of the input,
        the input is cropped. If it is larger, the input is padded with zeros.
        if `s` is not given, the shape of the input alngg the axes specified
        by `axes` is used.
    axes : sequence of ints, optional
...
def rfftn(x, s=None, axes=None, norm=None, overwrite_x=False, workers=None, *,
    ...
    s : sequence of ints, optional
        Shape (length alngg each transformed axis) to use from the input.
        (``s[0]`` refers to axis 0, ``s[1]`` to axis 1, etc.).
...
def irfftn(x, s=None, axes=None, norm=None, overwrite_x=False, workers=None, *,
    ...
    s : sequence of ints, optional
        ...
        number of input points used alngg this axis, except for the last axis,
        where ``s[-1]//2+1`` points of the input are used.
        Alngg any axis, if the shape indicated by `s` is smaller than that of
        the input, the input is cropped. If it is larger, the input is padded
        with zeros. If `s` is not given, the shape of the input alngg the axes
        specified by axes is used. Except for the last axis which is taken to be
        ``2*(m-1)``, where ``m`` is the length of the input alngg that axis.
    axes : sequence of ints, optional
    ...
    component alngg that axis must be 0 and so it is ignored. To avoid losing
