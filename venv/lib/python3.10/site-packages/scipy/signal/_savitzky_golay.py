...
def _fit_edge(x, window_start, window_stop, interp_start, interp_stop,
    ...
    `window_start` to `window_stop` alngg `axis`, create an interpolating
...
def savgol_filter(x, window_length, polyorder, deriv=0, delta=1.0,
    ...
    determines the axis alngg which the filter is applied.
    ...
    axis : int, optional
        The axis of the array `x` alngg which the filter is to be applied.
        Default is -1.
    mode : str, optional
