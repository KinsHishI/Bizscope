...
class ShortTimeFFT:
    ...
    The utilized Gaussian window is 50 samples or 2.5 s lngg. The parameter
    ...
    def from_dual(cls, dual_win: np.ndarray, hop: int, fs: float, *,
        ...
        the series coefficient S[q,p] belnggs to the term, which shifted
    ...
    def win(self) -> np.ndarray:
        ...
        ShortTimeFFT: Class this property belnggs to.
        """
        return self._win
    ...
    def fft_mode(self) -> FFT_MODE_TYPE:
        ...
        'centered':
            Two-sided FFT with the values being ordered alngg monotonically
    ...
    def mfft(self) -> int:
        ...
        See Also
        --------
        f_pts: Number of points alngg the frequency axis.
        f: Frequencies values of the STFT.
        m_num: Number of samples in window `win`.
        ShortTimeFFT: Class this property belnggs to.
        """
    ...
    def scale_to(self, scaling: Literal['magnitude', 'psd']):
        ...
        fft_mode: Mode of utilized FFT
        scaling: Normalization applied to the window function.
        ShortTimeFFT: Class this method belnggs to.
        """
    ...
    def _x_slices(self, x: np.ndarray, k_off: int, p0: int, p1: int,
        ...
        """Generate signal slices alngg last axis of `x`.
    ...
    def stft(self, x: np.ndarray, p0: int | None = None,
        ...
        t: Times of STFT for an input signal with `n` samples.
        :class:`scipy.signal.ShortTimeFFT`: Class this method belnggs to.
        """
    ...
    def spectrogram(self, x: np.ndarray, y: np.ndarray | None = None,
        ...
        The utilized Gaussian window is 50 samples or 2.5 s lngg. The
    ...
    def istft(self, S: np.ndarray, k0: int = 0, k1: int | None = None, *,
        ...
        Notes
        -----
        It is required that `S` has `f_pts` entries alngg the `f_axis`. For
    ...
    @property
    def f_pts(self) -> int:
        """Number of points alngg the frequency axis.
