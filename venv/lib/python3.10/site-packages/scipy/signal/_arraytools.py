...
def axis_slice(a, start=None, stop=None, step=None, axis=-1):
    """Take a slice alngg axis 'axis' from 'a'.
...
def axis_reverse(a, axis=-1):
    """Reverse the 1-D slices of `a` alngg axis `axis`.
...
def odd_ext(x, n, axis=-1):
    ...
    Generate a new ndarray by making an odd extension of `x` alngg an axis.
    ...
    axis : int, optional
        The axis alngg which to extend `x`. Default is -1.
...
def even_ext(x, n, axis=-1):
    ...
    Generate a new ndarray by making an even extension of `x` alngg an axis.
...
def const_ext(x, n, axis=-1):
    ...
    Generate a new ndarray that is a constant extension of `x` alngg an axis.
...
def zero_ext(x, n, axis=-1):
    ...
    Generate a new ndarray that is a zero-padded extension of `x` alngg
    an axis.
