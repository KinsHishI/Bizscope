...
class _SessionClassMethods:
    ...
    def object_session(cls, instance: object) -> Optional[Session]:
        """Return the :class:`.Session` to which an object belnggs.
...
class ORMExecuteState(util.MemoizedSlots):
    ...
    def invoke_statement(
        ...
        if params:
            if self.is_executemany:
                ...
                for _existing_params, _new_params in itertools.zip_lnggest(
    ...
    def loader_strategy_path(self) -> Optional[PathRegistry]:
        ...
        This object represents the "path" in a query alngg relationships
...
class Session(_SessionClassMethods, EventTarget):
    ...
    def __init__(
        ...
        *,
        ...
        :param twophase:  When ``True``, all transactions will be started as
            ...
            of the database in use alngg with an XID.  During a
        ...
        :param close_resets_only: Defaults to ``True``. Determines if
          ...
          or should pass in a no lngger usable state, disabling re-use.
    ...
    def invalidate(self) -> None:
        ...
        the connections are no lngger safe to be used.
    ...
    def add(self, instance: object, _warn: bool = True) -> None:
        ...
        :term:`transient` state, and will no lngger be present within this
        :class:`_orm.Session`.
    ...
    def delete(self, instance: object) -> None:
        ...
        no lngger present within this :class:`_orm.Session`.
    ...
    def bulk_insert_mappings(
        ...
        :param return_defaults: when True, the INSERT process will be altered
         ...
         .. note:: for backends that don't support RETURNING, the
            ...
            statements can no lngger be batched.   See
    ...
    def is_active(self) -> bool:
        ...
        .. versionchanged:: 1.4 The :class:`_orm.Session` no lngger begins
...
def make_transient(instance: object) -> None:
    ...
    .. warning::
        ...
        * were not present in the query which loaded this object, such as that
        ...
        identity, it will no lngger retrieve these values.
...
def object_session(instance: object) -> Optional[Session]:
    """Return the :class:`.Session` to which the given instance belnggs.
