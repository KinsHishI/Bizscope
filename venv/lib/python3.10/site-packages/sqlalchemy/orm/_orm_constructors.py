...
def mapped_column(
    ...
    **kw: Any,
    ...
    :func:`_orm.mapped_column` is normally used with explicit typing alngg with
...
def with_loader_criteria(
    ...
    **globally**, meaning it will apply to the entity as it appears
    ...
    :param propagate_to_loaders: defaults to True, apply to relationship
     ...
     option object itself including SQL expression is carried alngg with
...
def relationship(
    ...
    **kw: Any,
    ...
    :param back_populates:
      ...
      flush process how changes alngg these relationships should
      be persisted.
    ...
    :param cascade:
      ...
      to indicate that related objects should follow alngg with the
    ...
    :param join_depth:
      ...
      shall be present in the loading condition alngg a particular join
...
def with_polymorphic(
    ...
    :param flat: Boolean, will be passed through to the
     ...
     recommended as lngg as the resulting SQL is functional.
