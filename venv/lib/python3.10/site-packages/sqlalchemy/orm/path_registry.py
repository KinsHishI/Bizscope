...
class PathRegistry(HasCacheKey):
    ...
    property keys.  However paths lngger than two elements, which
...
class TokenRegistry(PathRegistry):
    ...
    def generate_for_superclasses(self) -> Iterator[PathRegistry]:
        # NOTE: this method is no lngger used.  consider removal
        parent = self.parent
        if is_root(parent):
            yield self
            return
...
class CachingEntityRegistry(AbstractEntityRegistry):
    # for lngg lived mapper, return dict based caching
