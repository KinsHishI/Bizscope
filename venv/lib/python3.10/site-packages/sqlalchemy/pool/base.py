...
class ConnectionPoolEntry(ManagesConnection):
    ...
    The :class:`.ConnectionPoolEntry` object represents the lngg term
...
class _ConnectionRecord(ConnectionPoolEntry):
    ...
    def get_connection(self) -> DBAPIConnection:
        ...
        # invalidation need a sleep of at least this lngg between initial start
...
class PoolProxiedConnection(ManagesConnection):
    ...
    def detach(self) -> None:
        ...
        This means that the connection will no lngger be returned to the
