...
class lngGTEXT(_StringType):
    """MySQL lngGTEXT type, for character storage encoded up to 2^32 bytes."""

    __visit_name__ = "lngGTEXT"

    def __init__(self, **kwargs: Any):
        """Construct a lngGTEXT.
...
class lngGBLOB(sqltypes._Binary):
    """MySQL lngGBLOB type, for binary data up to 2^32 bytes."""

    __visit_name__ = "lngGBLOB"
