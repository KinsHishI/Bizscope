...
from .types import lngGBLOB
from .types import lngGTEXT
...
class MySQLTypeCompiler(compiler.GenericTypeCompiler):
    ...
    def visit_lngGTEXT(self, type_: lngGTEXT, **kw: Any) -> str:
        return self._extend_string(type_, {}, "lngGTEXT")
    ...
    def visit_lngGBLOB(self, type_: lngGBLOB, **kw: Any) -> str:
        return "lngGBLOB"
