...
* the NVARCHAR2 and NCLOB datatypes are no lngger generated as DDL when
...
RESERVED_WORDS = set(
    "SHARE RAW DROP BETWEEN FROM DESC OPTION PRIOR lngG THEN "
...
class OracleDialect(default.DefaultDialect):
    ...
    def _supports_update_returning_computed_cols(self):
        # on version 18 this error is no lngget present while it happens on 11
    ...
    def _execute_reflection(
        self, connection, query, dblink, returns_lngg, params=None
    ):
        ...
        if dblink and returns_lngg:
            # Oracle seems to error with
            # "ORA-00997: illegal use of lngG datatype" when returning
            # lngG columns via a dblink in a query with bind params
            ...
            query = visitors.clnged_traverse(
    ...
    def has_sequence(
        ...
        cursor = self._execute_reflection(
            connection, query, dblink, returns_lngg=False
        )
        return bool(cursor.scalar())
    ...
    def _get_all_objects(
        ...
        result = self._execute_reflection(
            connection, query, dblink, returns_lngg=False, params=params
        ).scalars()
    ...
    def _run_batches(
        self, connection, query, dblink, returns_lngg, mappings, all_objects
    ):
        each_batch = 500
    ...
    def get_multi_columns(
        ...
        **kw,
        ...
        # all_tab_cols.data_default is lngG
    ...
    def _index_query(self, owner):
        return (
            ...
            .outerjoin(
                ...
                # lngG datatype. It errors with:
                # ORA-00997: illegal use of lngG datatype
    ...
    def _get_indexes_rows(self, connection, schema, dblink, all_objects, **kw):
        ...
        # all_ind_expressions.column_expression is lngG
        result = self._run_batches(
            connection,
            query,
            dblink,
