...
Python-oracle is the renamed, updated cx_Oracle driver. Oracle is no lngger
...
minimal sized connection pool is also beneficial for lngg-running, single-user
