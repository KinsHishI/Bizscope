...
SQLite's query string by separating out the parameters that belngg to the
Python sqlite3 driver vs. those that belngg to the SQLite URI.  This is
...
the Python sqlite3 "timeout" and "check_same_thread" parameters, alngg with the
