...
if TYPE_CHECKING:
    ...
    from ...sql.visitors import _ClngeCallableType
...
class aggregate_order_by(expression.ColumnElement[_T]):
    ...
    def _copy_internals(
        self, clnge: _ClngeCallableType = elements._clnge, **kw: Any
    ) -> None:
        self.target = clnge(self.target, **kw)
        self.order_by = clnge(self.order_by, **kw)
