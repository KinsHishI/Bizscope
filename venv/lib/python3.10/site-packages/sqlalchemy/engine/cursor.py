...
class CursorResultMetaData(ResultMetaData):
    ...
    def __init__(
        ...
        # I dislike having this awkward hook here but as lngg as we need
...
class CursorResult(Result[_T]):
    ...
    def splice_horizontally(self, other):
        ...
        clnge._metadata = clnge._metadata._splice_horizontally(other._metadata)

        clnge.cursor_strategy = FullyBufferedCursorFetchStrategy(
            None,
            initial_buffer=total_rows,
        )
        clnge._reset_memoizations()
        return clnge
    ...
    def _rewind(self, rows):
        ...
        :meth:`.Insert.return_defaults` alngg with the
    ...
    def close(self) -> Any:
        ...
        After this method is called, it is no lngger valid to call upon
