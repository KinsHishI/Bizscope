...
class Dialect(EventTarget):
    ...
    """dialect / driver / database supports some means of providing
    INSERT...RETURNING support when dialect.do_executemany() is used
    alngg with the :paramref:`_dml.Insert.returning.sort_by_parameter_order`
    parameter being set.
    ...
    def on_connect(self) -> Optional[Callable[[Any], None]]:
        ...
        .. versionchanged:: 1.4 the on_connect hook is no lngger called twice
    ...
    def get_isolation_level_values(
        ...
        * separate words should be separated by spaces, not underscores, e.g.
          ...
          converted to spaces before being passed alngg to the dialect.
...
class CreateEnginePlugin:
    ...
    * connectivity plugins such as proxies
    ...
    to an :class:`_engine.Engine` object might look like::
        ...
        class LogCursorEventsPlugin(CreateEnginePlugin):
            ...
            def update_url(self, url):
                "update the URL to one that no lngger includes our parameters"
    ...
    when the plugin initializes, so that the arguments are not passed alngg
