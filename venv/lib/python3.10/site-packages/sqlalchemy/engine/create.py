...
@util.deprecated_params(
    ...
    empty_in_strategy=(
        ...
        "deprecated, and no lngger has any effect.  All IN expressions "
...
def create_engine(url: Union[str, _url.URL], **kwargs: Any) -> Engine:
    ...
    :param empty_in_strategy:   No lngger used; SQLAlchemy now uses
    ...
    :param future: Use the 2.0 style :class:`_engine.Engine` and
        ...
        .. versionchanged:: 2.0 All :class:`_engine.Engine` objects are
           "future" style engines and there is no lngger a ``future=False``
           mode of operation.
