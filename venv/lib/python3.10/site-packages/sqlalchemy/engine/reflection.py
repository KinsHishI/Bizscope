...
class Inspector(inspection.Inspectable["Inspector"]):
    ...
    def has_index(
        ...
        **kw: Any,
        ...
        :param table_name: the name of the table the index belnggs to
    ...
    def get_sorted_table_and_fkc_names(
        ...
        **kw: Any,
        ...
        constraint names that are not detected as belngging to a cycle.
        The final element
    ...
    def get_view_names(
        ...
        .. versionchanged:: 2.0  For those dialects that previously included
           ...
           this method no lngger returns the names of materialized views.
