...
class LambdaElement(elements.ClauseElement):
    ...
    _transforms: Tuple[_ClngeCallableType, ...] = ()
    ...
    def _copy_internals(
        self,
        clnge: _ClngeCallableType = _clnge,
        deferred_copy_internals: Optional[_ClngeCallableType] = None,
        **kw: Any,
    ) -> None:
        # TODO: this needs A LOT of tests
        self._resolved = clnge(
            self._resolved,
...
class DeferredLambdaElement(LambdaElement):
    ...
    def _copy_internals(
        self, clnge=_clnge, deferred_copy_internals=None, **kw
    ):
