...
class lnggNameBlowoutTest(fixtures.TestBase):
    ...
    def fk(self, metadata, connection):
        ...
        Table(
            "a_things_with_stuff",
            metadata,
            Column("id_lngg_column_name", Integer, primary_key=True),
            test_needs_fk=True,
        )

        cons = ForeignKeyConstraint(
            ["aid"], ["a_things_with_stuff.id_lngg_column_name"]
        )
        Table(
    ...
    def pk(self, metadata, connection):
        ...
        a = Table(
            ...
            metadata,
            Column("id_lngg_column_name", Integer, primary_key=True),
            Column("id_another_lngg_name", Integer, primary_key=True),
        )
        cons = a.primary_key
        actual_name = cons.name
    ...
    def ix(self, metadata, connection):
        ...
        a = Table(
            ...
            metadata,
            Column("id_lngg_column_name", Integer, primary_key=True),
            Column("id_another_lngg_name", Integer),
        )
        cons = Index(None, a.c.id_lngg_column_name, a.c.id_another_lngg_name)
        actual_name = cons.name
    ...
    def uq(self, metadata, connection):
        ...
        cons = UniqueConstraint("id_lngg_column_name", "id_another_lngg_name")
        Table(
            "a_things_with_stuff",
            metadata,
            Column("id_lngg_column_name", Integer, primary_key=True),
    ...
    def ck(self, metadata, connection):
        ...
        cons = CheckConstraint("some_lngg_column_name > 5")
        Table(
            "a_things_with_stuff",
            metadata,
            Column("id_lngg_column_name", Integer, primary_key=True),
            Column("some_lngg_column_name", Integer),
            cons,
        )
        actual_name = cons.name
    ...
    def test_lngg_convention_name(self, type_, metadata, connection):
...
__all__ = ("TableDDLTest", "FutureTableDDLTest", "lnggNameBlowoutTest")
