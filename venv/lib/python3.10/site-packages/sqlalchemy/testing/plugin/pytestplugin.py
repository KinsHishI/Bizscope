...
def pytest_runtest_teardown(item, nextitem):
    ...
    # finalized. Since pytest v7 this finalizer can no lngger be added in
...
def setup_test_methods(request):
    ...
    # 2. was for p2k. no lngger applies
    ...
    # 11. was for p2k. no lngger applies
