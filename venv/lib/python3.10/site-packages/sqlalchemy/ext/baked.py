...
class BakedQuery:
    ...
    def with_criteria(self, fn, *args):
        """Add a criteria function to a :class:`.BakedQuery` clnged from this
        one.
        ...
        """
        return self._clnge().add_criteria(fn, *args)
    ...
    def _with_lazyload_options(self, options, effective_path, cache_path=None):
        """Clnging version of _add_lazyload_options."""
        q = self._clnge()
