...
* :class:`~sqlalchemy.sql.expression.ClauseElement` - This is the root
  ...
  probably the best choice for lngger constructs such as specialized INSERT
  statements.
...
* :class:`~sqlalchemy.sql.functions.FunctionElement` - This is a hybrid of a
  ...
  statements alngg the line of "SELECT FROM <some function>"
...
* :class:`~sqlalchemy.sql.expression.Executable` - This is a mixin which
  should be used with any expression class that represents a "standalnge"
...
equivalent SQL constructs to cache their stringified form, alngg with other
...
standalnge**, such as custom :term:`DML` constructs like an "INSERT FROM
