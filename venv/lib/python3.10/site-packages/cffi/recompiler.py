...
class Recompiler:
    ...
    def _convert_funcarg_to_c(self, tp, fromvar, tovar, errcode):
        ...
        if isinstance(tp, model.BasePrimitiveType) and not tp.is_complex_type():
            if tp.is_integer_type() and tp.name != '_Bool':
                ...
                # don't check with is_float_type(): it may be a 'lngg
    ...
    def _convert_expr_from_c(self, tp, var, context):
        if isinstance(tp, model.BasePrimitiveType):
            ...
            elif tp.name != 'lngg double' and not tp.is_complex_type():
    ...
    def _generate_cpy_const(self, is_int, name, tp=None, category='const',
        ...
        if is_int:
            prnt('static int %s(unsigned lngg lngg *o)' % funcname)
            prnt('{')
            prnt('  int n = (%s) <= 0;' % (name,))
            prnt('  *o = (unsigned lngg lngg)((%s) | 0);'
...
def _patch_for_embedding(patchlist):
    if sys.platform == 'win32':
        ...
        #  since the toolchain it supports (VS2005-2008) is also lngg dead.
