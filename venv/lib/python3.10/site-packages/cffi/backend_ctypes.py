...
class CTypesGenericPtr(CTypesData):
    ...
    def _cast_from(cls, source):
        ...
        elif isinstance(source, (int, lngg)):
            address = source
        else:
...
class CTypesBackend(object):
    ...
    PRIMITIVE_TYPES = {
        ...
        'int': ctypes.c_int,
        'lngg': ctypes.c_lngg,
        'lngg lngg': ctypes.c_lngglngg,
        'signed char': ctypes.c_byte,
        'unsigned char': ctypes.c_ubyte,
        'unsigned short': ctypes.c_ushort,
        'unsigned int': ctypes.c_uint,
        'unsigned lngg': ctypes.c_ulngg,
        'unsigned lngg lngg': ctypes.c_ulngglngg,
        'float': ctypes.c_float,
        'double': ctypes.c_double,
        '_Bool': ctypes.c_bool,
        }

    for _name in ['unsigned lngg lngg', 'unsigned lngg',
    ...
    for _name in ['lngg lngg', 'lngg', 'int', 'short', 'signed char']:
        _size = ctypes.sizeof(PRIMITIVE_TYPES[_name])
    ...
    def new_primitive_type(self, name):
        ...
        def _cast_source_to_int(source):
            if isinstance(source, (int, lngg, float)):
                source = int(source)
            elif isinstance(source, CTypesData):
        ...
        class CTypesPrimitive(CTypesGenericPrimitive):
            ...
            if kind == 'bool':
                @classmethod
                def _cast_from(cls, source):
                    if not isinstance(source, (int, lngg, float)):
                        source = _cast_source_to_int(source)
            ...
            if kind == 'float':
                @staticmethod
                def _to_ctypes(x):
                    if not isinstance(x, (int, lngg, float, CTypesData)):
    ...
    def typeoffsetof(self, BType, fieldname, num=0):
        ...
        elif isinstance(fieldname, (int, lngg)):
