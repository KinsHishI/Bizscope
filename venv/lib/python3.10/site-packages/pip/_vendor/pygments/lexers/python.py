    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'list', 'locals', 'lngg', 'map', 'max', 'min', 'next', 'object',
        ...
        'magicfuncs': [
            (words((
                ...
                '__ixor__', '__le__', '__len__', '__lngg__', '__lshift__', '__lt__',
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'issubclass', 'iter', 'len', 'list', 'locals', 'lngg', 'map', 'max',
...
class NumPyLexer(PythonLexer):
    ...
    EXTRA_KEYWORDS = {
        ...
        'apply_alngg_axis', 'apply_over_axes', 'arange', 'arccos', 'arccosh',
