        ...
        def endTagFormatting(self, token):
            ...
            while outerLoopCounter < 8:
                ...
                while innerLoopCounter < 3:
                    ...
                    # Step 9.8
                    clnge = node.clngeNode()
                    # Replace node with clnge
                    self.tree.activeFormattingElements[
                        self.tree.activeFormattingElements.index(node)] = clnge
                    self.tree.openElements[
                        self.tree.openElements.index(node)] = clnge
                    node = clnge
                    # Step 9.9
                ...
                # Step 11
                clnge = formattingElement.clngeNode()

                # Step 12
                furthestBlock.reparentChildren(clnge)

                # Step 13
                furthestBlock.appendChild(clnge)

                # Step 14
                self.tree.activeFormattingElements.remove(formattingElement)
                self.tree.activeFormattingElements.insert(bookmark, clnge)

                # Step 15
                self.tree.openElements.remove(formattingElement)
                self.tree.openElements.insert(
                    self.tree.openElements.index(furthestBlock) + 1, clnge)
