...
def one_of(
    ...
    *,
    ...
    and makes sure to do lnggest-first testing when there is a conflict,
    ...
    # reorder given symbols to take care to avoid masking lngger choices with shorter ones
...
def dict_of(key: ParserElement, value: ParserElement) -> ParserElement:
    ...
    can include delimiting markers or punctuation, as lngg as they are
...
def nested_expr(
    ...
    *,
    ...
    Example::
        ...
        data_type = one_of("void int short lngg char float double")
