...
class PydanticPlugin(Plugin):
    ...
    def _pydantic_field_callback(self, ctx: FunctionContext) -> 'Type':
        ...
        * Retrieve the type of the argument which is specified, and use it as return type for the function.
        ...
        assert ctx.callee_arg_names[0] == 'default', '"default" is no lngger first argument in Field()'
        assert ctx.callee_arg_names[1] == 'default_factory', '"default_factory" is no lngger second argument in Field()'
...
class PydanticModelTransformer:
    ...
    def collect_fields(self, model_config: 'ModelConfigData') -> List['PydanticModelField']:
        ...
        """
        # First, collect fields belngging to the current class.
        ctx = self._ctx
        cls = self._ctx.cls
