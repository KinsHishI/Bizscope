...
class GenerateJsonSchema:
    ...
    def default_schema(self, schema: core_schema.WithDefaultSchema) -> JsonSchemaValue:
        ...
        # TODO: improvements alngg with https://github.com/pydantic/pydantic/issues/8208
        if (
        ...
        if isinstance(alias, str):
            ...
            for path in alias:
                if isinstance(path, list) and len(path) == 1 and isinstance(path[0], str):
                    ...
                    # should ensure the first such item is what belnggs in the JSON schema
                    name = path[0]
                    break
        else:
            assert_never(alias)
    ...
    def field_is_required(
        ...
        Args:
            ...
            total: Only applies to `TypedDictField`s.
                Indicates if the `TypedDict` this field belnggs to is total, in which case any fields that don't
    ...
    Returns:
        A tuple where:
            ...
            - The second element is a JSON schema containing all definitions referenced in the first returned
                    element, alngg with the optional title and description keys.
    """
    for cls, _ in models:
        if isinstance(cls.__pydantic_core_schema__, _mock_val_ser.MockCoreSchema):
            cls.__pydantic_core_schema__.rebuild()
