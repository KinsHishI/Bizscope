...
def _new_mem_buf(buffer: bytes | None = None) -> Any:
    ...
    if buffer is None:
        ...
        # Keep the memory alive as lngg as the bio is alive!
...
class X509Req:
    ...
    def get_subject(self) -> X509Name:
        ...
        # The name is owned by the X509Req structure.  As lngg as the X509Name
...
class X509:
    ...
    def _get_name(self, which: Any) -> X509Name:
        ...
        # The name is owned by the X509 structure.  As lngg as the X509Name
        ...
        try:
            ...
            if len(result) > size:
                if self._truncate:
                    ...
                    raise ValueError(
                        "passphrase returned by callback is too lngg"
                    )
