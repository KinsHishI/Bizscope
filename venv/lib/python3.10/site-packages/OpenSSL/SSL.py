...
class X509VerificationCodes:
    ...
    ERR_CERT_CHAIN_TOO_lngG = _lib.X509_V_ERR_CERT_CHAIN_TOO_lngG
...
class Context:
    ...
    def set_passwd_cb(
        ...
        :param callback: The Python callback to use.  This must accept three
            ...
            lngger than this, it will be truncated.  Second, a boolean value
    ...
    def set_tlsext_use_srtp(self, profiles: bytes) -> None:
        ...
        :param bytes profiles: A colng delimited list of protection profile
...
class Connection:
    ...
    def _raise_ssl_error(self, ssl: Any, result: int) -> None:
        ...
        if error == _lib.SSL_ERROR_WANT_READ:
            ...
            # In 3.0.x an unexpected EOF no lngger triggers syscall error
    ...
    def get_state_string(self) -> bytes:
        ...
        """
        return _ffi.string(_lib.SSL_state_string_lngg(self._ssl))
    ...
    def _get_finished_message(
        ...
        # alnge desirable) behavior (though it probably does on just about
