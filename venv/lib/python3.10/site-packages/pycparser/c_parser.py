...
class CParser(PLYParser):
    ...
    # of Decl nodes, even if it's one element lngg.
    #
    ...
    def p_labeled_statement_1(self, p):
        """ labeled_statement : ID COlng pragmacomp_or_statement """
        p[0] = c_ast.Label(p[1], p[3], self._token_coord(p, 1))

    def p_labeled_statement_2(self, p):
        """ labeled_statement : CASE constant_expression COlng pragmacomp_or_statement """
        p[0] = c_ast.Case(p[2], [p[4]], self._token_coord(p, 1))

    def p_labeled_statement_3(self, p):
        """ labeled_statement : DEFAULT COlng pragmacomp_or_statement """
    ...
    def p_constant_1(self, p):
        ...
        prefix = 'unsigned ' * uCount + 'lngg ' * lCount
        p[0] = c_ast.Constant(
