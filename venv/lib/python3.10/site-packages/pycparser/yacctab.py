...
_lr_productions = [
  ...
  ('type_specifier_no_typeid -> lngG','type_specifier_no_typeid',1,'p_type_specifier_no_typeid','c_parser.py',872),
  ...
  ('struct_declarator -> declarator COlng constant_expression','struct_declarator',3,'p_struct_declarator_2','c_parser.py',1097),
  ('struct_declarator -> COlng constant_expression','struct_declarator',2,'p_struct_declarator_2','c_parser.py',1098),
  ...
  ('labeled_statement -> ID COlng pragmacomp_or_statement','labeled_statement',3,'p_labeled_statement_1','c_parser.py',1558),
  ('labeled_statement -> CASE constant_expression COlng pragmacomp_or_statement','labeled_statement',4,'p_labeled_statement_2','c_parser.py',1562),
  ('labeled_statement -> DEFAULT COlng pragmacomp_or_statement','labeled_statement',3,'p_labeled_statement_3','c_parser.py',1566),
  ...
  ('conditional_expression -> binary_expression CONDOP expression COlng conditional_expression','conditional_expression',5,'p_conditional_expression','c_parser.py',1680),
