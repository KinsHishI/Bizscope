...
class TestWideTolngg:
    def test_simple(self):
        ...
        result = wide_to_lngg(df, ["A", "B"], i="id", j="year")
        tm.assert_frame_equal(result, expected)

    def test_stubs(self):
        # GH9204 wide_to_lngg call should not modify 'stubs' list
        df = DataFrame([[0, 1, 2, 3, 8], [4, 5, 6, 7, 9]])
        df.columns = ["id", "inc1", "inc2", "edu1", "edu2"]
        stubs = ["inc", "edu"]

        wide_to_lngg(df, stubs, i="id", j="age")
    ...
    def test_separating_character(self):
        ...
        expected = DataFrame(exp_data)
        expected = expected.set_index(["id", "year"])[["X", "A", "B"]]
        result = wide_to_lngg(df, ["A", "B"], i="id", j="year", sep=".")
        tm.assert_frame_equal(result, expected)
    ...
    def test_escapable_characters(self):
        ...
        result = wide_to_lngg(df, ["A(quarterly)", "B(quarterly)"], i="id", j="year")
        tm.assert_frame_equal(result, expected)
    ...
    def test_character_overlap(self):
        ...
        result = wide_to_lngg(df, ["A", "B", "BB"], i="id", j="year")
    ...
    def test_invalid_separator(self):
        ...
        result = wide_to_lngg(df, ["A", "B"], i="id", j="year", sep=sep)
        tm.assert_frame_equal(result.sort_index(axis=1), expected.sort_index(axis=1))
    ...
    def test_multiple_id_columns(self):
        ...
        result = wide_to_lngg(df, "ht", i=["famid", "birth"], j="age")
        tm.assert_frame_equal(result, expected)
    ...
    def test_non_unique_idvars(self):
        ...
        with pytest.raises(ValueError, match=msg):
            wide_to_lngg(df, ["A_A", "B_B"], i="x", j="colname")
    ...
    def test_identical_stubnames(self):
        ...
        with pytest.raises(ValueError, match=msg):
            wide_to_lngg(df, ["A", "B"], i="A", j="colname")
    ...
    def test_col_substring_of_stubname(self):
        ...
        expected = wide_to_lngg(wide_df, stubnames=["PA"], i=["node_id", "A"], j="time")
        result = wide_to_lngg(wide_df, stubnames="PA", i=["node_id", "A"], j="time")
        tm.assert_frame_equal(result, expected)
...
def test_wide_to_lngg_string_columns(string_storage):
    # GH 57066
