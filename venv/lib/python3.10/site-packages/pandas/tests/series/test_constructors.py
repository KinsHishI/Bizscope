...
class TestSeriesConstructors:
    ...
    def test_constructor_floating_data_int_dtype(self, frame_or_series):
        ...
        # lngg-standing behavior (for Series, new in 2.0 for DataFrame)
        #  has been to ignore the dtype on these;
        #  not clear if this is what we want lngg-term
    ...
    def test_constructor_dtype_datetime64_6(self):
        # as of 2.0, these no lngger infer datetime64 based on the strings,
    ...
    def test_construction_to_datetimelike_unit(self, arr_dtype, kind, unit):
        # tests all units
        # gh-19223
        # TODO: GH#19223 was about .astype, doesn't belngg here
        dtype = f"{kind}8[{unit}]"
    ...
    def test_constructor_dtype_timedelta64(self):
        ...
        # as of 2.0, these no lngger infer timedelta64 based on the strings,
...
class TestSeriesConstructorIndexCoercion:
    def test_series_constructor_datetimelike_index_coercion(self):
        ...
        # as of 2.0, we no lngger silently cast the object-dtype index
