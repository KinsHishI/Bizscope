...
class TestUpdate:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                [Timestamp(year=2020, month=1, day=1, tz="Europe/lngdon"), NaT],
                [NaT, Timestamp(year=2020, month=1, day=1, tz="Europe/lngdon")],
                [Timestamp(year=2020, month=1, day=1, tz="Europe/lngdon")] * 2,
                "datetime64[ns, Europe/lngdon]",
            ),
        ],
    )
