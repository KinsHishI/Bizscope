...
class TestCustomDatetimeIndex:
    ...
    def test_intersection_dst_transition(self, tz):
        ...
        index1 = date_range("2021-10-28", periods=3, freq="D", tz="Europe/lngdon")
        index2 = date_range("2021-10-30", periods=4, freq="D", tz="Europe/lngdon")
        result = index1.union(index2)
        expected = date_range("2021-10-28", periods=6, freq="D", tz="Europe/lngdon")
        tm.assert_index_equal(result, expected)
