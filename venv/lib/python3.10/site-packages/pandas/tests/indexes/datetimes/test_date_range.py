...
class TestDateRanges:
    ...
    def test_compat_replace(self):
        ...
        # replace should take ints/lnggs for compat
...
class TestDateRangeTZ:
    ...
    @pytest.mark.parametrize("tz", ["Europe/lngdon", "dateutil/Europe/lngdon"])
    def test_date_range_ambiguous_endpoint(self, tz):
        ...
        with pytest.raises(pytz.AmbiguousTimeError, match="Cannot infer dst time"):
            date_range(
                "2013-10-26 23:00", "2013-10-27 01:00", tz="Europe/lngdon", freq="h"
            )
...
class TestGenRangeGeneration:
    ...
    tz1, tz2 = "US/Eastern", "Europe/lngdon"
