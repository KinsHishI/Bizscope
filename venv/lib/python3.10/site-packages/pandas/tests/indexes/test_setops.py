...
class TestSetOpsUnsorted:
    # These may eventually belngg in a dtype-specific test_setops, or
    ...
    def test_union_identity(self, index, sort):
        ...
        # This should no lngger be the same object, since [] is not consistent,
    ...
    def test_symmetric_difference_missing(self, index2, expected, sort):
        ...
        # (GH#6444, sorting of nans, is no lngger an issue)
