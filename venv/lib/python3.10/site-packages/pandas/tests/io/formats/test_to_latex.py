...
@pytest.fixture
def df_short():
    """Short dataframe for testing table/tabular/lnggtable LaTeX env."""
...
class TestToLatexlnggtable:
    def test_to_latex_empty_lnggtable(self):
        df = DataFrame()
        result = df.to_latex(lnggtable=True)
        expected = _dedent(
            r"""
            \begin{lnggtable}{l}
            \toprule
    ...
    def test_to_latex_lnggtable_with_index(self):
        df = DataFrame({"a": [1, 2], "b": ["b1", "b2"]})
        result = df.to_latex(lnggtable=True)
        expected = _dedent(
            r"""
    ...
    def test_to_latex_lnggtable_without_index(self):
        df = DataFrame({"a": [1, 2], "b": ["b1", "b2"]})
        result = df.to_latex(index=False, lnggtable=True)
        expected = _dedent(
            r"""
            \begin{lnggtable}{rl}
            \toprule
    ...
    def test_to_latex_lnggtable_continued_on_next_page(self, df, expected_number):
        result = df.to_latex(index=False, lnggtable=True)
...
class TestToLatexCaptionLabel:
    ...
    @pytest.fixture
    def caption_lnggtable(self):
        """Caption for lnggtable LaTeX environment."""
        return "a table in a \\texttt{lnggtable} environment"

    @pytest.fixture
    def label_lnggtable(self):
        """Label for lnggtable LaTeX environment."""
        return "tab:lnggtable"
    ...
    def test_to_latex_caption_and_shortcaption_list_is_ok(self, df_short):
        caption = ("lngg-lngg-caption", "Short")
    ...
    def test_to_latex_caption_shortcaption_and_label(
        ...
        # test when the short_caption is provided alnggside caption and label
    ...
    def test_to_latex_two_chars_caption(self, df_short):
        ...
        # it must not be unpacked into lngg_caption, short_caption.
    ...
    def test_to_latex_lnggtable_caption_only(self, df_short, caption_lnggtable):
        # GH 25436
        # test when no caption and no label is provided
        # is performed by test_to_latex_lnggtable()
        result = df_short.to_latex(lnggtable=True, caption=caption_lnggtable)
        expected = _dedent(
            r"""
            \begin{lnggtable}{lrl}
            \caption{a table in a \texttt{lnggtable} environment} \\
            \toprule
             & a & b \\
            \midrule
            \endfirsthead
    ...
    def test_to_latex_lnggtable_label_only(self, df_short, label_lnggtable):
        # GH 25436
        result = df_short.to_latex(lnggtable=True, label=label_lnggtable)
        expected = _dedent(
            r"""
            \begin{lnggtable}{lrl}
            \label{tab:lnggtable} \\
    ...
    def test_to_latex_lnggtable_caption_and_label(
        self,
        df_short,
        caption_lnggtable,
        label_lnggtable,
        ...
        result = df_short.to_latex(
            lnggtable=True,
            caption=caption_lnggtable,
            label=label_lnggtable,
        )
        expected = _dedent(
            r"""
        \begin{lnggtable}{lrl}
        \caption{a table in a \texttt{lnggtable} environment} \label{tab:lnggtable} \\
        \toprule
         & a & b \\
        \midrule
        \endfirsthead
    ...
    def test_to_latex_lnggtable_caption_shortcaption_and_label(
        self,
        df_short,
        caption_lnggtable,
        short_caption,
        ...
        result = df_short.to_latex(
            lnggtable=True,
            caption=(caption_lnggtable, short_caption),
            label=label_lnggtable,
        )
        expected = _dedent(
            r"""
\begin{lnggtable}{lrl}
\caption[a table]{a table in a \texttt{lnggtable} environment} \label{tab:lnggtable} \\
\toprule
 & a & b \\
\midrule
\endfirsthead
...
class TestToLatexPosition:
    ...
    def test_to_latex_lnggtable_position(self):
        the_position = "t"
        df = DataFrame({"a": [1, 2], "b": ["b1", "b2"]})
        result = df.to_latex(lnggtable=True, position=the_position)
        expected = _dedent(
            r"""
            \begin{lnggtable}[t]{lrl}
            \toprule
             & a & b \\
            \midrule
            \endfirsthead
