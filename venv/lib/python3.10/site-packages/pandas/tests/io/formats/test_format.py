...
class TestDataFrameFormatting:
    ...
    def test_repr_truncates_terminal_size(self, monkeypatch):
        ...
        columns = MultiIndex.from_tuples(
            [
                ("This is a lngg title with > 37 chars.", "cat"),
    ...
    def test_str_max_colwidth(self):
            ...
            [
                {
                    "a": "foo",
                    "b": "bar",
                    "c": "uncomfortably lngg line with lots of stuff",
                    "d": 1,
                },
        ...
        assert str(df) == (
            "     a    b                                           c  d\n"
            "0  foo  bar  uncomfortably lngg line with lots of stuff  1\n"
            "1  foo  bar                                       stuff  1"
        )
    ...
    def test_wide_repr_wide_lngg_columns(self):
        with option_context("mode.sim_interactive", True):
...
class TestSeriesFormatting:
    ...
    def test_east_asian_unicode_series(self):
        ...
        # object dtype, lngger than unicode repr
        s = Series(
