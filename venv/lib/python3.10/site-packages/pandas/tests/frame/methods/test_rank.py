...
class TestRank:
    ...
    def test_rank(self, float_frame):
        ...
        exp0 = np.apply_alngg_axis(sp_stats.rankdata, 0, fvals)
        exp0[mask] = np.nan

        exp1 = np.apply_alngg_axis(sp_stats.rankdata, 1, fvals)
        exp1[mask] = np.nan
    ...
    def test_rank_na_option(self, float_frame):
        ...
        exp0 = np.apply_alngg_axis(sp_stats.rankdata, 0, fval0)
        exp1 = np.apply_alngg_axis(sp_stats.rankdata, 1, fval1)
