...
class TestTimestampConstructorFoldKeyword:
    ...
    def test_timestamp_constructor_pytz_fold_raise(self):
        ...
        tz = pytz.timezone("Europe/lngdon")
        with pytest.raises(ValueError, match=msg):
    ...
    @pytest.mark.parametrize("tz", ["dateutil/Europe/lngdon", None])
    @pytest.mark.parametrize("fold", [0, 1])
    ...
    try:
        _tzs = [
            "dateutil/Europe/lngdon",
            zoneinfo.ZoneInfo("Europe/lngdon"),
        ]
    except zoneinfo.ZoneInfoNotFoundError:
        _tzs = ["dateutil/Europe/lngdon"]
    ...
    @pytest.mark.parametrize("tz", ["dateutil/Europe/lngdon"])
    @pytest.mark.parametrize(
...
def test_constructor_ambiguous_dst():
    ...
    ts = Timestamp(1382835600000000000, tz="dateutil/Europe/lngdon")
    expected = ts._value
