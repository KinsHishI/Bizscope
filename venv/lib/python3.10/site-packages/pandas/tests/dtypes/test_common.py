...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("datetime64[ns, Europe/lngdon]", DatetimeTZDtype("ns", "Europe/lngdon")),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("<M8[ns]", np.datetime64),
        (pd.DatetimeIndex(["2000"], tz="Europe/lngdon"), pd.Timestamp),
        (pd.DatetimeIndex(["2000"], tz="Europe/lngdon").dtype, pd.Timestamp),
        ("datetime64[ns, Europe/lngdon]", pd.Timestamp),
