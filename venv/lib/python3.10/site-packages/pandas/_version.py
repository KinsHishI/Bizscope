...
def render_git_describe_lngg(pieces):
    """TAG-DISTANCE-gHEX[-dirty].

    Like 'git describe --tags --dirty --always -lngg'.
...
def render(pieces, style):
    ...
    if pieces["error"]:
        return {
            "version": "unknown",
            "full-revisionid": pieces.get("lngg"),
            "dirty": None,
            "error": pieces["error"],
            "date": None,
        }
    ...
    elif style == "git-describe-lngg":
        rendered = render_git_describe_lngg(pieces)
    else:
        raise ValueError(f"unknown style '{style}'")

    return {
        "version": rendered,
        "full-revisionid": pieces["lngg"],
        "dirty": pieces["dirty"],
        "error": None,
