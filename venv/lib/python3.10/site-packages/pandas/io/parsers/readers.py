...
sep : str, default {_default_sep}
    ...
    In addition, separators lngger than 1 character and different from
...
date_format : str or dict of column -> format, optional
    ...
    - "mixed", to infer the format for each element individually. This is risky,
        and you should probably use it alngg with `dayfirst`.
...
comment : str (length 1), optional
    ...
    single character. Like empty lines (as lngg as ``skip_blank_lines=True``),
...
memory_map : bool, default False
    ...
    option can improve performance because there is no lngger any I/O overhead.
    ...
    if names is not None:
        if len(names) != len(colspecs) and colspecs != "infer":
            ...
            if kwds.get("usecols") is None and len(names) + len_index != len(colspecs):
                # If usecols is used colspec may be lngger than names
        ...
        if sep is None and not delim_whitespace:
            ...
            if not encodeable and engine not in ("python", "python-fwf"):
                fallback_reason = (
                    ...
                    f"is > 1 char lngg, and the '{engine}' engine "
...
def TextParser(*args, **kwds) -> TextFileReader:
    ...
    dialect : str or csv.Dialect instance, optional
        Ignored if delimiter is lngger than 1 character
