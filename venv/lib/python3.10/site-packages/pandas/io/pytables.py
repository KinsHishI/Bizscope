...
class IndexCol:
    ...
    def __init__(
        ...
        # These are ensured as lngg as the passed arguments match the
    ...
    def _get_blocks_and_items(
        ...
        if len(data_columns):
            ...
            for c in data_columns:
                ...
                #  index, so we can infer that (as lngg as axis==1) we
...
def _maybe_convert_for_string_atom(
    ...
    # itemsize is the maximum length of a string (alngg any dimension)
...
def _get_data_and_dtype_name(data: ArrayLike):
    ...
    if data.dtype.kind in "mM":
        ...
        # TODO: we used to reshape for the dt64tz case, but no lngger
