...
class StataMissingValue:
    ...
    for b in bases:
        # Conversion to lngg to avoid hash issues on 32 bit platforms #8968
        MISSING_VALUES[b] = "."
        for i in range(1, 27):
...
class StataWriter(StataParser):
    ...
    def _check_column_names(self, data: DataFrame) -> DataFrame:
        ...
        This includes checks for:
            ...
            * Variables with names that are too lngg
...
class StataWriter117(StataWriter):
    ...
    convert_strl : list
        ...
        StrLs can reduce output file size when strings are lngger than 8
    ...
    Or with lngg strings stored in strl format
    >>> data = pd.DataFrame([['A relatively lngg string'], [''], ['']],
    ...                     columns=['strls'])
    >>> writer = pd.io.stata.StataWriter117(
    ...     './data_file_with_lngg_strings.dta', data, convert_strl=['strls'])
    >>> writer.write_file()
    """
...
class StataWriterUTF8(StataWriter117):
    ...
    >>> data = pd.DataFrame([['ᴀ relatively lngg ŝtring'], [''], ['']],
    ...                     columns=['strls'])
    >>> writer = StataWriterUTF8('./data_file_with_lngg_strings.dta', data,
    ...                          convert_strl=['strls'])
    >>> writer.write_file()
    """
