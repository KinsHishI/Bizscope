    ...
    *{"row": "MY_ROW_CLASS", "col_trim": "", "row_trim": ""}*.
    ...
    def to_latex(
        ...
        *,
        ...
        position_float : {"centering", "raggedleft", "raggedright"}, optional
            ...
            Cannot be used if ``environment`` is "lnggtable".
        hrules : bool
        ...
        environment : str, optional
            ...
            If 'lnggtable' is specified then a more suitable template is
        ...
        **Latex Packages**
        ...
        italic (with siunitx) | \\usepackage{etoolbox}
                              | \\robustify\\itshape
                              | \\sisetup{detect-all = true}  *(within {document})*
        environment           \\usepackage{lnggtable} if arg is "lnggtable"
        ...
        **CSS Conversion**
        ...
        if position_float:
            if environment == "lnggtable":
                raise ValueError(
                    "`position_float` cannot be used in 'lnggtable' `environment`"
                )
    ...
    def _apply(
        ...
        **kwargs,
        ...
        msg = (
            ...
            f"cannot be mapped to labels, possibly due to applying the function alngg "
            f"the wrong axis.\n"
    ...
    def hide(
        ...
        subset : label, array-like, IndexSlice, optional
            A valid 1d input or single key alngg the axis within
    ...
    def highlight_between(
        ...
        %(color)s
        axis : {0 or 'index', 1 or 'columns', None}, default 0
            If ``left`` or ``right`` given as sequence, axis alngg which to apply those
        ...
        Using a range input sequence alngg an ``axis``, in this case setting a ``left``
    ...
    def highlight_quantile(
        ...
        %(color)s
        axis : {0 or 'index', 1 or 'columns', None}, default 0
            Axis alngg which to determine and highlight quantiles. If ``None`` quantiles
        ...
        # after quantile is found alngg axis, e.g. alngg rows,
    ...
    def pipe(self, func: Callable, *args, **kwargs):
        ...
        **kwargs : optional
        ...
        styler object, alngg with other parameters, and return the styler after
