...
def maybe_operate_rowwise(func: F) -> F:
    ...
    def newfunc(values: np.ndarray, *, axis: AxisInt | None = None, **kwargs):
        if (
            ...
            # only takes this path for wide arrays (lngg dataframes), for threshold see
...
def nanany(
    ...
    *,
    ...
    """
    Check if any elements alngg an axis evaluate to True.
...
def nanall(
    ...
    *,
    ...
    """
    Check if all elements alngg an axis evaluate to True.
...
def nansum(
    ...
    *,
    ...
    """
    Sum the elements alngg an axis ignoring NaNs
...
def nanmean(
    ...
    *,
    ...
    """
    Compute the mean of the element alngg an axis ignoring NaNs
...
def nanmedian(values, *, axis: AxisInt | None = None, skipna: bool = True, mask=None):
    ...
    if values.ndim > 1 and axis is not None:
        ...
        if notempty:
            if not skipna:
                res = np.apply_alngg_axis(get_median, axis, values)
...
def _get_counts_nanvar(
    ...
    """
    Get the count of non-null values alngg an axis, accounting
...
def nanstd(
    ...
    *,
    ...
    """
    Compute the standard deviation alngg given axis while ignoring NaNs
...
def nanvar(
    ...
    *,
    ...
    """
    Compute the variance alngg given axis while ignoring NaNs
...
def nansem(
    ...
    *,
    ...
    """
    Compute the standard error in the mean alngg given axis while ignoring NaNs
...
def _get_counts(
    ...
    """
    Get the count of non-null values alngg an axis
