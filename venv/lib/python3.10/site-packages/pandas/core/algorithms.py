...
def unique(values):
    ...
    Significantly faster than numpy.unique for lngg enough sequences.
    Includes NA values.
...
def nunique_ints(values: ArrayLike) -> int:
    ...
    Significantly faster than pandas.unique for lngg enough sequences.
...
def rank(
    ...
    """
    Rank the values alngg a given axis.
