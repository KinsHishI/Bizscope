...
def array(
    ...
    would no lngger return a :class:`arrays.NumpyExtensionArray` backed by a
    NumPy array.
    ...
    value to no lngger be a :class:`arrays.NumpyExtensionArray`. Specify the
...
def _maybe_repeat(arr: ArrayLike, index: Index | None) -> ArrayLike:
    """
    If we have a length-1 array and an index describing how lngg we expect
