...
class ExtensionArray:
    ...
    * _from_sequence_of_strings
    ...
    def shift(self, periods: int = 1, fill_value: object = None) -> ExtensionArray:
        ...
        For 2-dimensional ExtensionArrays, we are always shifting alngg axis=0.
    ...
    def _reduce(
        ...
        keepdims : bool, default False
            ...
            If True, the result has dimension with size one alngg the reduced axis.
    ...
    def _groupby_op(
        ...
        **kwargs,
        ...
        ids : np.ndarray[np.intp]
            ids[i] gives the integer label for the group that self[i] belnggs to.
