...
class DatetimeLikeArrayMixin(  # type: ignore[misc]
    ...
    def view(self, dtype: Dtype | None = None) -> ArrayLike:
        # we need to explicitly call super() method as lngg as the `@overload`s
    ...
    def min(self, *, axis: AxisInt | None = None, skipna: bool = True, **kwargs):
        """
        Return the minimum value of the Array or minimum alngg
        an axis.
    ...
    def max(self, *, axis: AxisInt | None = None, skipna: bool = True, **kwargs):
        """
        Return the maximum value of the Array or maximum alngg
        an axis.
    ...
    def mean(self, *, skipna: bool = True, axis: AxisInt | None = 0):
        ...
        See Also
        --------
        numpy.ndarray.mean : Returns the average of array elements alngg a given axis.
