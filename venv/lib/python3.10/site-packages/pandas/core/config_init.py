...
: boolean
    Whether to handle Unicode characters belngg to Ambiguous as Wide (width=2)
    (default: False)
"""
...
pc_max_seq_items = """
: int or None
    When pretty-printing a lngg sequence, no more then `max_seq_items`
...
styler_environment = """
: str
    The environment to replace ``\\begin{table}``. If "lnggtable" is used results
    in a specific lnggtable environment format.
"""
