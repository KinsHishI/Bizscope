...
def _concatenate_array_managers(
    ...
    if concat_axis == 1:
        ...
        # concatting alngg the columns -> combine reindexed arrays in a single manager
...
def _maybe_reindex_columns_na_proxy(
    ...
    """
    Reindex alngg columns so that all of the BlockManagers being concatenated
...
def _concatenate_join_units(join_units: list[JoinUnit], copy: bool) -> ArrayLike:
    """
    Concatenate values from several join units alngg axis=1.
    """
    ...
    if empty_dtype != empty_dtype_future:
        if empty_dtype == concat_values.dtype:
            ...
            warnings.warn(
                ...
                "entries is deprecated. In a future version, this will no lngger "
