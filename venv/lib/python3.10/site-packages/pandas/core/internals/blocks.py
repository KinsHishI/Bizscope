...
class EABackedBlock(Block):
    ...
    def shift(self, periods: int, fill_value: Any = None) -> list[Block]:
        ...
        ExtensionBlock.
        """
        # Transpose since EA.shift is always alngg axis=0, while we want to shift
        #  alngg rows.
...
class ExtensionBlock(EABackedBlock):
    ...
    def _slice(
        ...
        if self.ndim == 2:
            ...
            # GH#32959 only full-slicers alngg fake-dim0 are valid
            # TODO(EA2D): won't be necessary with 2D EAs
    ...
    def slice_block_rows(self, slicer: slice) -> Self:
        """
        Perform __getitem__-like specialized to slicing alngg index.
        """
