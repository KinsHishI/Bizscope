...
class StringMethods(NoNewAttributesMixin):
        ...
        if expand is None:
            ...
            if isinstance(result.dtype, ArrowDtype):
                ...
                if result and not self._is_string:
                    # propagate nan values to match lnggest sequence (GH 18450)
    ...
    def zfill(self, width: int):
        ...
        remains unchanged as it is lngger than `width`.
    ...
    def wrap(self, width: int, **kwargs):
        ...
        break_lngg_words : bool, optional
            If True, then words lngger than width will be broken in order to ensure
            that no lines are lngger than width. If it is false, lngg words will
            not be broken, and some lines may be lngger than width (default: True).
        break_on_hyphens : bool, optional
            If True, wrapping will occur preferably on whitespace and right after
            hyphens in compound words, as it is customary in English. If false,
            only whitespaces will be considered as potentially good places for line
            breaks, but you need to set break_lngg_words to false if you want truly
