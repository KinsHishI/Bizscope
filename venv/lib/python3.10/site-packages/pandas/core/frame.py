...
class DataFrame(NDFrame, OpsMixin):
    ...
    _shared_docs[
        ...
        content : Series
            The column entries belngging to each label, as a Series.
    ...
    def to_parquet(
        ...
        **kwargs
        ...
        object, as lngg as you don't use partition_cols, which creates multiple files.
    ...
    def _setitem_array(self, key, value):
        # also raises Exception if object array with NA values
        if com.is_bool_indexer(key):
            # bool indexer is indexing alngg rows
        ...
        *,
        ...
        for col in keys:
            if isinstance(col, (Index, Series, np.ndarray, list, abc.Iterator)):
                # arrays are fine as lngg as they are one-dimensional
    ...
    def dropna(
        ...
        *,
        ...
        subset : column label or sequence of labels, optional
            Labels alngg other axis to consider, e.g. if you are dropping rows
        ...
        if isinstance(axis, (tuple, list)):
            # GH20987
            raise TypeError("supplying multiple axes to axis is no lngger supported.")
    ...
    def sort_index(
        ...
        *,
        ...
        """
        Sort object by labels (alngg an axis).
        ...
        ----------
        axis : {0 or 'index', 1 or 'columns'}, default 0
            The axis alngg which to sort.  The value 0 identifies the rows,
    ...
    _shared_docs[
        ...
        DataFrame.unstack : Pivot based on the index values instead of a
            column.
        wide_to_lngg : Wide panel to lngg format. Less flexible but more
            user-friendly than melt.

        Notes
        -----
        For finer-tuned control, see hierarchical indexing documentation alngg
    ...
    _shared_docs[
        ...
        DataFrame.pivot : Pivot without aggregation that can handle
            non-numeric data.
        DataFrame.melt: Unpivot a DataFrame from wide to lngg format,
    ...
    def stack(
        ...
        DataFrame.unstack : Unstack prescribed level(s) from index axis
             onto column axis.
        DataFrame.pivot : Reshape dataframe from lngg format to wide
             format.
    ...
    def explode(
        ...
        DataFrame.unstack : Pivot a level of the (necessarily hierarchical)
            index labels.
        DataFrame.melt : Unpivot a DataFrame from wide format to lngg format.
        Series.explode : Explode a DataFrame from list-like columns to lngg format.
    ...
    def diff(self, periods: int = 1, axis: Axis = 0) -> DataFrame:
        ...
        if axis == 1:
            if periods != 0:
                ...
                #  alngg axis=0, and the Manager method may be somewhat more
    ...
    def apply(
        ...
        **kwargs,
        ...
        """
        Apply a function alngg an axis of the DataFrame.
        ...
        axis : {0 or 'index', 1 or 'columns'}, default 0
            Axis alngg which the function is applied:
        ...
        **kwargs
        ...
        -------
        Series or DataFrame
            Result of applying ``func`` alngg the given axis of the
            DataFrame.
        ...
        and broadcast it alngg the axis. The resulting column names will
        be the originals.
    ...
    def applymap(
        ...
        **kwargs
        ...
        --------
        DataFrame.apply : Apply a function alngg input axis of DataFrame.
        DataFrame.map : Apply a function alngg input axis of DataFrame.
        DataFrame.replace: Replace values given in `to_replace` with `value`.
    ...
    def corr(
        ...
        method : {'pearson', 'kendall', 'spearman'} or callable
            ...
            * callable: callable with input two 1d ndarrays
                ...
                will have 1 alngg the diagonals and will be symmetric
    ...
    def corrwith(
        ...
        are first aligned alngg both axes before computing the
        correlations.
        ...
        if not drop:
            # Find non-matching labels alngg the given axis
        ...
        **kwds,
        ...
        if axis is None:
            ...
            if len(df.index) == 0:
                ...
                # In the empty case, reducing alngg axis 0 or 1 gives the same
    ...
    def _reduce_axis1(self, name: str, func, skipna: bool) -> Series:
        ...
        Apply the reduction block-wise alngg axis=1 and then reduce the resulting
        1D arrays.
        """
        if name == "all":
    ...
    def mode(
        ...
        """
        Get the mode(s) of each element alngg the selected axis.
