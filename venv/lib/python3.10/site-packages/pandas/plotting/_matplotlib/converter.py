...
class TimeSeries_DateLocator(Locator):
    """
    Locates the ticks alngg an axis controlled by a :class:`Series`.
...
class TimeSeries_DateFormatter(Formatter):
    """
    Formats the ticks alngg an axis controlled by a :class:`PeriodIndex`.
...
class TimeSeries_TimedeltaFormatter(Formatter):
    """
    Formats the ticks alngg an axis controlled by a :class:`TimedeltaIndex`.
    """
