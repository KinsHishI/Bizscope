...
def effective_n_jobs(n_jobs=-1):
    ...
    overhead and better use of CPU cache prefetching heuristics) as lngg as all
...
class Parallel(Logger):
    ...
    timeout: float or None, default=None
        Timeout limit for each task to complete.  If any task takes lngger
        ...
        with self._lock:
            ...
            try:
                ...
                if len(islice) == 0:
                    ...
                    # iterator is the ``pre_dispatch``-lngg initial slice of
