...
class ParallelBackendBase(metaclass=ABCMeta):
    ...
    def effective_n_jobs(self, n_jobs):
        ...
        as lngg as all the workers have enough work to do.
        """
    ...
    def batch_completed(self, batch_size, duration):
        """Callback indicate how lngg it took to run a batch"""
...
class AutoBatchingMixin(object):
    ...
    # Should not be too high to avoid stragglers: lngg jobs running alnge
    ...
    def compute_batch_size(self):
        ...
        if batch_duration > 0 and batch_duration < self.MIN_IDEAL_BATCH_DURATION:
            ...
            # The current batch size is too big. If we schedule overly lngg
            # running batches some CPUs might wait with nothing left to do
            # while a couple of CPUs a left processing a few lngg running
        ...
        if batch_size != old_batch_size:
            ...
            # CallBack as lngg as the batch_size is constant. Therefore
